(function($) {
	 ...
	 * @constructor
	 * */
	let MyCustomAppear1 = function(ctx) {
	...
	MyCustomAppear1.prototype = {
		"_initStyles": function() {
			let styleElem = $("#msdb-eg-custom-control");
		...
		"_initList": function() {
			let list = this.msdbCtx.get("list", null, !1);
		...
		"getLastLab$": function() {
			let $holder = this.msdbCtx.get("$my-selected-holder", null, !1);
