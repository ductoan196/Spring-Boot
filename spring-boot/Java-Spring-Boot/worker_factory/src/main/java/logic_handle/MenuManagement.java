...
public class MenuManagement {
    ...
    private void printMenu() {
        System.out.println("----------------PHẦN MỀM QUẢN LÝ CHẤM CÔNG----------------");
        System.out.println("1. Nhập vào danh sách công nhân mới và in ra màn hình");
        System.out.println("2. Nhập danh sách phân xưởng mới và in ra màn hình");
