    ...
    [802], {
        ...
        43083: function(t, e, n) {
                ...
                l = function(t) {
                    function e(e) {
                        var n = e.options,
                            ...
                            i = e.result,
                            o = e.setResult,
                            s = t.call(this, n, r) || this;
                        return s.runMutation = function(t) {
                            void 0 === t && (t = {}), s.onMutationStart();
                            var e = s.generateNewMutationId();
                            return s.mutate(t).then((function(t) {
                                return s.onMutationCompleted(t, e), t
                            })).catch((function(t) {
                                var n = s.getOptions().onError;
                                if (s.onMutationError(t, e), n) return n(t), {
                                    data: void 0,
                                    errors: t
                                };
                                throw t
                            }))
                        }, s.verifyDocumentType(n.mutation, a.n_.Mutation), s.result = i, s.setResult = o, s.mostRecentMutationId = 0, s
                    }
            ...
            function f(t, e) {
                var n = (0, i.useContext)((0, p.K)()),
                    ...
                    c = (0, i.useRef)();
                var f = (c.current || (c.current = new l({
                    options: u,
                    context: n,
                    result: a,
                    setResult: s
                })), c.current);
                return f.setOptions(u), f.context = n, (0, i.useEffect)((function() {
            ...
            var r = n(31191),
                ...
                c = function(t) {
                    ...
                    return (0, r.ZT)(e, t), e.prototype.execute = function() {
                        ...
                        var t = this.getOptions();
                        this.verifyDocumentType(t.query, u.n_.Query);
                        ...
                        void 0 === t && (t = this.onNewData), this.currentSubscription || this.getOptions().skip || (this.currentSubscription = this.currentObservable.subscribe({
                            next: function(n) {
                                var r = n.loading,
                                    ...
                                    a = n.data,
                                    s = e.previous.result;
                                s && s.loading === r && s.networkStatus === i && (0, o.D)(s.data, a) || t()
                            },
                            error: function(n) {
                        ...
                        if (e.skip) t = (0, r.pi)((0, r.pi)({}, t), {
                            ...
                            if (l && l.length > 0 && (p = new a.c({
                                ...
                                if (e.partialRefetch && u && (!i || 0 === Object.keys(i).length) && "cache-only" !== f) return Object.assign(t, {
                                    loading: !0,
                                    networkStatus: s.I.loading
                                }), t.refetch(), t
                            }
                        ...
                        return this.previous.loading = h && h.loading || !1, t.previousData = h && (h.data || h.previousData), this.previous.result = t, this.currentObservable && this.currentObservable.resetQueryStoreErrors(), t
            ...
            function p(t, e, n) {
                ...
                var a = (0, i.useContext)((0, l.K)()),
                    ...
                    d = h.current || (h.current = new c({
                        ...
                        context: a,
                        onNewData: function() {
                            d.ssrInitiated() ? p() : Promise.resolve().then((function() {
                                return h.current && h.current.isMounted && p()
                            }))
                        }
                    }));
                d.setOptions(f), d.context = a;
                var v = function(t, e) {
                        var n = (0, i.useRef)();
                ...
                }), [m.loading, m.networkStatus, m.error, m.data, d.currentObservable]), v
            }
        },
        14222: function(t, e, n) {
            ...
            function s(t) {
                ...
                __DEV__ ? (0, i.kG)(!s.length || u.length || c.length || l.length, "Passing only a fragment to 'graphql' is not yet supported. You must include a query, subscription or mutation as well") : (0, i.kG)(!s.length || u.length || c.length || l.length, 35), __DEV__ ? (0, i.kG)(u.length + c.length + l.length <= 1, "react-apollo only supports a query, subscription, or a mutation per HOC. " + t + " had " + u.length + " queries, " + l.length + " subscriptions and " + c.length + " mutations. You can use 'compose' to join multiple operation types to a component") : (0, i.kG)(u.length + c.length + l.length <= 1, 36), n = u.length ? r.Query : r.Mutation, u.length || c.length || (n = r.Subscription);
        ...
        55392: function(t, e, n) {
            ...
            function f(t) {
                var e = t.primaryCta,
                    n = t.onClickArgs,
                    r = t.buttonClassName;
                return e ? i.createElement(o.Kq, {
                    className: r,
                    alignItems: "center",
                    gap: 3
                }, i.createElement(o.zx, {
                    href: e.link,
                    size: "large",
                    onClick: function() {
                        return e.onClick && e.onClick(n)
                    },
                    wide: !0
                }, i.createElement(a.Z, {
                    text: e.title
            ...
            var h = function(t) {
                ...
                return i.createElement(o.br, {
                    ...
                    onAfterOpen: y,
                    fill: !0,
                    footer: i.createElement(f, {
                        primaryCta: v,
                        onClickArgs: x,
                        buttonClassName: l
                    })
                }, i.createElement(o.Kq, {
                    alignItems: "center",
                    className: s,
                    gap: 3
                }, n, i.createElement(o.xv, {
                    tagName: "strong",
                    variant: "headline_2",
                    align: "center"
                }, e), h && h.map((function(t) {
                    return i.createElement(o.xv, {
                        align: "center",
                        key: t,
                        variant: "body_1",
                        tagName: "p",
                        ...
                        components: [i.createElement("b", {
                            className: p,
                            key: "not used"
                        })]
                    }))
                })), d && i.createElement(o.zx, {
                    href: d.link,
                    onClick: function() {
                        return d.onClick && d.onClick(x)
                    },
                    variant: "tertiary",
                    className: c,
                    wide: !0
        ...
        21141: function(t, e, n) {
            "use strict";
            var r = n(60633);
            e.Z = r.Z
        },
        47354: function(t, e, n) {
            "use strict";
            n.d(e, {
                Z: function() {
                    return l
            ...
            function u(t, e) {
                var n = t.replace(s, "").split(a);
                if (1 === n.length) return t;
                var l = [],
                    p = n.shift();
                p && l.push(p);
                for (var f = 0, h = 0, d = c(n); h < d.length; h++) {
                    var v = (0, i.Z)(d[h], 3),
                        m = v[0],
                        b = v[1],
                        g = v[2];
                    if (e && e[m]) {
                        f += 1;
                        var y = e[m];
                        if ((0, o.isElement)(y)) l.push((0, r.cloneElement)(y, {
                            key: f
                        }, b ? u(b, e) : y.props.children));
                        else {
                            if (!(0, o.isValidElementType)(y)) {
                                l.push("\ud83d\udca2");
                                continue
                            }
                            l.push((0, r.createElement)(y, {
                                key: f
                            }, b && u(b, e)))
                        }
                    } else l.push("\ud83d\udca2");
                ...
                var e = t.text,
                    ...
                    o = function(t, e) {
                        ...
                        return Object.keys(e).reduce((function(t, n) {
                            return t.split("[".concat(n, "]")).join(e[n] + "")
                        }), t)
                    }(e, n);
                return r.createElement(r.Fragment, null, u(o, i))
            }
        },
        45875: function(t, e, n) {
            ...
            var r, i, o, a = n(20011),
                ...
                h = n(60170);
            ! function(t) {
                t.APP_BANNER = "CAPLA_EVENT_app_banner_will_be_displayed"
            }(r || (r = {})),
            function(t) {
                t.EXPERIMENT_VARIANT = "CAPLA_EVENT_genius_sign_in_sheet_sr_variant", t.DISPATCH_TRACK_CLOSE_CUSTOM_GOAL = "CAPLA_EVENT_genius_sign_in_sheet_sr_track_close", t.DISPATCH_TRACK_ON_SHEET_SHOWN_STAGE = "CAPLA_EVENT_genius_sign_in_sheet_sr_track_on_sheet_shown"
            }(i || (i = {})),
            function(t) {
                t.EXPERIMENT_VARIANT = "CAPLA_EVENT_genius_sign_in_sheet_index_variant", t.DISPATCH_TRACK_CLOSE_CUSTOM_GOAL = "CAPLA_EVENT_genius_sign_in_sheet_index_track_close", t.DISPATCH_TRACK_ON_SHEET_SHOWN_STAGE = "CAPLA_EVENT_genius_sign_in_sheet_index_track_on_sheet_shown"
            }(o || (o = {}));
            var d = n(18950),
                v = n(92577),
                m = n(72975),
            ...
            function y(t, e) {
                ...
                return (0, s.useEffect)((function() {
                    ...
                    function r() {
                        return (r = (0, d.Z)(b().mark((function r() {
                            var a;
                            return b().wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    ...
                                    case 2:
                                        return r.prev = 2, r.next = 5, new Promise((function(n) {
                                            g.Y.publish(t, {
                                                metaData: e,
                                                resolve: n
                                            })
            ...
            var O = function() {
                var t = (0, s.useState)("LOADING"),
                    e = (0, v.Z)(t, 2),
                    n = e[0],
                    r = e[1];
                return (0, s.useEffect)((function() {
                    function t(t) {
                        var e = t.detail.willBannerBeShown ? "WILL_BE_SHOWN" : "WILL_NOT_BE_SHOWN";
                        r(e)
                    }
                    return document.addEventListener("cookie_banner_loaded", t),
                        function() {
                            return document.removeEventListener("cookie_banner_loaded", t)
                        }
                }), []), n
            };
            ...
            function _() {
                var t, e, n, i = O(),
                    o = function() {
                        var t = y(r.APP_BANNER);
                        return void 0 === t ? "LOADING" : t ? "WILL_BE_SHOWN" : "WILL_NOT_BE_SHOWN"
                    }(),
                    a = (0, f.T)(),
                    s = null !== (t = null === (e = a.getUserIdentity()) || void 0 === e ? void 0 : e.authLevel) && void 0 !== t ? t : 0,
                    u = null === (n = a.getAffiliate()) || void 0 === n ? void 0 : n.isGeniusAffiliate;
                return !(0 !== s || !u || "WILL_NOT_BE_SHOWN" !== o || "WILL_NOT_BE_SHOWN" !== i)
            }
            var S = ["mousemove", "click", "keypress", "scroll"];
                ...
                var e = t.expVariant,
                    ...
                    r = function(t) {
                        ...
                        return (0, s.useEffect)((function() {
                            ...
                            if (!e) return i ? n() : (a.current || t(), S.forEach((function(e) {
                                return document.addEventListener(e, t)
                            })), n);

                            function t() {
                                a.current && clearTimeout(a.current), a.current = u.current && setTimeout(u.current, 5e3)
                            }

                            function n() {
                                a.current && clearTimeout(a.current), S.forEach((function(e) {
            ...
            function P(t) {
                ...
                return (0, x.w)({
                    componentId: t,
                    encryptedCommonOauthState: r.getEncryptedCommonOauthState(),
                    environment: r.getBPlatformEnvironment(),
                    affiliateId: (null === (e = r.getAffiliate()) || void 0 === e || null === (n = e.id) || void 0 === n ? void 0 : n.toString()) || "",
            ...
            var L = function(t) {
                var e, n = t.experimentEvents;
                return {
                    expVariant: y(null !== (e = null === n || void 0 === n ? void 0 : n.EXPERIMENT_VARIANT) && void 0 !== e ? e : "") || 0,
                    trackOnSheetShown: function() {
                        n && g.Y.publish(n.DISPATCH_TRACK_ON_SHEET_SHOWN_STAGE)
                    },
                    trackClose: function() {
                        n && g.Y.publish(n.DISPATCH_TRACK_CLOSE_CUSTOM_GOAL)
                    }
                }
            };
            ...
            function N(t) {
                var e = t.children,
                    n = P("genius_index_sheet"),
                    r = L({
                        experimentEvents: o
                    }),
                    i = r.expVariant,
                    a = r.trackOnSheetShown,
                    u = r.trackClose,
                    c = function(t) {
                        var e = t.expVariant;
                        return _() && e > 0
            ...
            function T(t) {
                var e = t.children,
                    n = P("genius_searchresults_sheet"),
                    r = L({
                        experimentEvents: i
                    }),
                    o = r.expVariant,
            ...
            var z = function() {
                    var t = (0, s.useContext)(E),
                        e = t.signInLink,
                        n = t.shouldShow,
                        r = t.trackOnSheetShown,
                        i = t.trackClose,
                        o = (0, f.T)().getSiteType() === p.N.MDOT,
                        a = function(t) {
                            var e = G(G({}, V), t);
                            return M.a(Z, e)
                        }({
                        ...
                        c = (0, v.Z)(u, 1)[0];
                    if (null === a || void 0 === a || !a.geniusGuestData.signInBottomSheet) return null;
                    var l = o ? "bottom" : "center",
                        h = a.geniusGuestData.signInBottomSheet,
                        d = h.title,
                        m = h.subtitle,
                        b = h.signInCta.title;
                    return {
                        ...
                        closeAriaLabel: h.closeAriaLabel,
                        primaryCta: {
                            onClick: function(t) {
                                return (0, t.closeBottomSheet)()
                            },
                            title: b,
                            link: e
                        },
                ...
                q = function() {
                    var t = z();
                    return t ? s.createElement(u.Z, (0, a.Z)({}, t, {
                        header: s.createElement(l.xu, {
                            padding: 6
                        }, s.createElement(c.Z, {
                            size: "larger"
                        }))
            ...
            var F = function(t) {
                var e = t.isSearchResultsExperiment,
                    n = (0, f.T)().getSiteType();
                return e ? s.createElement(T, null, s.createElement(q, null)) : n === p.N.MDOT ? s.createElement(N, null, s.createElement(q, null)) : s.createElement(w, null, s.createElement(q, null))
            }
        },
        60170: function(t, e, n) {
            ...
            var o = function(t) {
                ...
                return e.searchParams.set("login_redirect", t), e.toString()
            }
        },
        602: function(t, e, n) {
            "use strict";
        ...
        60633: function(t, e, n) {
            ...
            e.Z = function(t) {
                var e = t.inverted,
                    ...
                    m = (0, o.Z)(t, f),
                    b = (0, c.QT)().trans;
                return l.createElement(s.JO, (0, r.Z)({}, function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {};
                    ...
                    ariaLabel: d || b((0, u.t)("www_ge_screenreader_generic_logo", {
                        variables: {
                            b_companyname: p.p
                        }
                    })),
        ...
        80827: function(t, e, n) {
            ...
            var r, i, o = n(79399),
                a = n(98178);
            ! function(t) {
                t.admin = "admin", t.app = "app", t.book = "book", t.join = "join"
            }(r || (r = {}));
            var s, u, c, l, p = ((i = {
                ...
                m = S(f.KVM),
                b = S(f.DQS),
                g = new RegExp("^(.*?)\\.?(" + h + "|booking.cn)$"),
                y = new RegExp("^(?:" + v.join("|") + ")(\\d+)$"),
                O = new RegExp("^(\\w+)-(" + m.join("|") + ").*?\\.dev$"),
                _ = new RegExp("(?:" + b.join("|") + ")\\.dqs$");
            ...
            function k(t, e) {
                ...
                null == e || e.forEach((function(e, r) {
                    n.has(r) ? t.append(r, e) : (t.set(r, e), n.add(r))
                }))
            }
                ...
                return function() {
                    ...
                    var n = function(t, e, n, r) {
                        var i = new URLSearchParams,
                            o = e && p.hasOwnProperty(e) ? e : "DEFAULT";
                        return p[o].forEach((function(e) {
                            var n = t.searchParams.get(e);
                            n && i.set(e, n)
                        })), "number" === typeof(null == n ? void 0 : n.id) && i.set("aid", n.id.toString()), (null == n ? void 0 : n.label) && i.set("label", n.label.toString()), r && t.searchParams.forEach((function(t, e) {
                            var n;
                            (0 === (n = e).indexOf("exp_") || 0 === n.indexOf("b_feature_running_") || "exp_all" === n || "hotel_account_id" === n || "i_am_from" === n || "my_ip" === n) && i.set(e, t)
                        })), i
                    }(e, t.getSiteType(), t.getAffiliate(), t.isInternalIp());
                    return function(r) {
                        var i = new URL("" + e.origin + e.pathname),
                            o = r.host ? function(t, e) {
                                var n = t.host.match(g);
                                if (!n) return t;
                                var r = n[1],
                                    i = n[2];
                                if ("" === r || d.includes(r)) {
                                    var o = E(f.PRODUCTION[e]);
                                    t.host = o + "." + i
                                } else if (O.test(r)) {
                                    var a = E(f.KVM[e]);
                                    t.host = r.replace(O, "$1-" + a + ".dev." + h)
                                } else if (_.test(r)) {
                                    var s = E(f.DQS[e]);
                                    t.host = s + ".dqs." + h
                                } else if (y.test(r)) {
                                    var u = E(f.STAGING[e]);
                                    t.host = r.replace(y, u + "$1." + h)
                                }
                                return t
                            }(i, r.host) : i;
                        return r.pathname && (o.pathname = r.pathname), o.hash = r.hash || "", t.isRobotRequest() || (k(o.searchParams, n), k(o.searchParams, r.searchParams)), o
                    }
                }()(t)
            }
        },
        72335: function(t, e, n) {
            "use strict";
            n.d(e, {
                w: function() {
                    return r
            ...
            var r = function(t) {
                var e = t.encryptedCommonOauthState,
                    n = "prod" === t.environment,
                    r = t.affiliateId,
                    i = t.language,
                    o = t.actionName,
                    a = n ? "vO1Kblk7xX9tUn2cpZLS" : "b_test_fe",
                    s = "https://".concat(function(t) {
                        return t ? "account.booking.com" : "account.dqs.booking.com"
                    }(n), "/auth/oauth2"),
                    u = "https://".concat(function(t) {
                        return t ? "secure.booking.com" : "book.dqs.booking.com"
                    }(n), "/login.html?op=oauth_return"),
                    c = new URL(s);
                if (c.searchParams.set("client_id", a), c.searchParams.set("redirect_uri", u), c.searchParams.set("response_type", t.anon ? "anon_session" : "code"), i && c.searchParams.set("lang", i), r && c.searchParams.set("aid", r), o && c.searchParams.set("bkng_action", o), e) {
                    t.encryptedCommonOauthState, t.environment;
                    var l = function(t, e) {
                        try {
                            var n = void 0,
                                r = JSON.stringify(e);
                            return n = btoa(r), "".concat(t, "*").concat(n)
                        } catch (i) {
                            return "".concat(t, "*")
                        }
                    }(e, function(t, e) {
                        ...
                        return n
                    }(t, ["encryptedCommonOauthState", "environment"]));
                    l && c.searchParams.set("state", l)
                }
                return c.toString()
            }
        },
        39649: function(t, e, n) {
            ...
            function i() {
                ...
                return m.prototype = b, a(_, "constructor", {
                    value: b,
                    configurable: !0
                }), a(b, "constructor", {
                    value: m,
                    configurable: !0
                }), m.displayName = p(b, l, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === m || "GeneratorFunction" === (e.displayName || e.name))
                }, e.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, b) : (t.__proto__ = b, p(t, l, "GeneratorFunction")), t.prototype = Object.create(_), t
                }, e.awrap = function(t) {
                    return {
                        __await: t
                    }
                }, S(k.prototype), p(k.prototype, c, (function() {
                    return this
                ...
                }, S(_), p(_, l, "Generator"), p(_, u, (function() {
                    return this
