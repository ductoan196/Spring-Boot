...
! function(e, t) {
    ...
    var p =
         ...
         */
        function(n) {
            var e, h, x, o, r, g, f, m, w, l, c, v, T, i, y, b, a, s, C, N = "sizzle" + 1 * new Date,
                E = n.document,
                k = 0,
                d = 0,
                u = oe(),
                ...
                if (!r && y) {
                    ...
                    if (h.qsa && (!b || !b.test(e))) {
                        if (f = c = N, d = t, p = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                            for (l = g(e), (c = t.getAttribute("id")) ? f = c.replace(ee, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;) l[u] = f + ge(l[u]);
            ...
            for (e in h = ie.support = {}, r = ie.isXML = function(e) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function(e) {
                            ...
                            return e[3] ? e[2] = e[4] || e[5] || "" : n && Q.test(n) && (t = g(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3)
                        }
                    },
                    filter: {
                        TAG: function(e) {
            ...
            function be(p, h, g, m, v, e) {
                return m && !m[N] && (m = be(m)), v && !v[N] && (v = be(v, e)), ae(function(e, t, n, r) {
                    var i, o, a, s = [],
                        u = [],
                        l = t.length,
                        c = e || function(e, t, n) {
            ...
            return he.prototype = x.filters = x.pseudos, x.setFilters = new he, g = ie.tokenize = function(e, t) {
                ...
                if (!a) {
                    ...
                    (a = S(e, (m = o, y = 0 < (v = i).length, b = 0 < m.length, r = function(e, t, n, r, i) {
                        var o, a, s, u = 0,
                            l = "0",
                            c = e && [],
                            f = [],
    ...
    C.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (!m) return;
            for (n.handler && (n = (u = n).handler, i = u.selector), n.guid || (n.guid = C.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || ((c = m.handle = function(e) {
                    return typeof C === M || e && C.event.triggered === e.type ? void 0 : C.event.dispatch.apply(c.elem, arguments)
                }).elem = e), s = (t = (t || "").match(D) || [""]).length; s--;) {
                if (p = g = (o = G.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), !p) continue;
        ...
        remove: function(e, t, n, r, i) {
            ...
            for (l = (t = (t || "").match(D) || [""]).length; l--;) {
                if (p = g = (s = G.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), !p) {
    ...
    function me(e, t) {
        ...
        if (!o)
            for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || C.nodeName(r, t) ? o.push(r) : C.merge(o, me(r, t));
    ...
    he.optgroup = he.option, he.tbody = he.tfoot = he.colgroup = he.caption = he.thead, he.th = he.td, C.extend({
        clone: function(e, t, n) {
            ...
            if (v.html5Clone || C.isXMLDoc(e) || !ie.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ge.innerHTML = e.outerHTML, ge.removeChild(o = ge.firstChild)), !(v.noCloneEvent && v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                for (r = me(o), s = me(e), a = 0; null != (i = s[a]); ++a) r[a] && Ce(i, r[a]);
            if (t)
                if (n)
                    for (s = s || me(e), r = r || me(o), a = 0; null != (i = s[a]); a++) Te(i, r[a]);
                else Te(e, o);
            return 0 < (r = me(o, "script")).length && we(r, !u && me(e, "script")), r = s = i = null, o
        },
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, d = te(t), p = [], h = 0; h < f; h++)
                ...
                for (s = s || d.appendChild(t.createElement("div")), u = (ae.exec(o) || ["", ""])[1].toLowerCase(), c = he[u] || he._default, s.innerHTML = c[1] + o + c[2], i = c[0]; i--;) s = s.lastChild;
                if (!v.leadingWhitespace && oe.test(o) && p.push(t.createTextNode(oe.exec(o)[0])), !v.tbody)
                    for (i = (o = "table" !== u || se.test(o) ? "<table>" !== c[1] || se.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) C.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
                for (C.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = d.lastChild
            } else p.push(t.createTextNode(o));
            for (s && d.removeChild(s), v.appendChecked || C.grep(me(p, "input"), ve), h = 0; o = p[h++];) {
                if (r && -1 !== C.inArray(o, r)) continue;
                if (a = C.contains(o.ownerDocument, o), s = me(d.appendChild(o), "script"), a && we(s), n)
        ...
        remove: function(e, t) {
            for (var n, r = e ? C.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || C.cleanData(me(n)), n.parentNode && (t && C.contains(n.ownerDocument, n) && we(me(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        html: function(e) {
            return X(this, function(e) {
                ...
                if ("string" == typeof e && !le.test(e) && (v.htmlSerialize || !ie.test(e)) && (v.leadingWhitespace || !oe.test(e)) && !he[(ae.exec(e) || ["", ""])[1].toLowerCase()]) try {
        ...
        domManip: function(n, r) {
            ...
            var e, t, i, o, a, s, u = 0,
                ...
                d = n[0],
                p = C.isFunction(d);
            if (p || 1 < l && "string" == typeof d && !v.checkClone && ce.test(d)) return this.each(function(e) {
                var t = c.eq(e);
            ...
            if (l && (e = (s = C.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === s.childNodes.length && (s = e), e)) {
                for (i = (o = C.map(me(s, "script"), be)).length; u < l; u++) t = s, u !== f && (t = C.clone(t, !0, !0), i && C.merge(o, me(t, "script"))), r.call(this[u], t, u);
                if (i)
                    for (a = o[o.length - 1].ownerDocument, C.map(o, xe), u = 0; u < i; u++) t = o[u], fe.test(t.type || "") && !C._data(t, "globalEval") && C.contains(a, t) && (t.src ? C._evalUrl && C._evalUrl(t.src) : C.globalEval((t.text || t.textContent || t.innerHTML || "").replace(pe, "")));
                s = e = null
            }
            return this
        }
    ...
    v.shrinkWrapBlocks = function() {
        ...
        var e, t, n;
        if (Ee = !1, !(t = N.getElementsByTagName("body")[0]) || !t.style) return;
    ...
    h.getComputedStyle ? (Ae = function(e) {
            ...
            return a = (n = n || Ae(e)) ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || C.contains(e.ownerDocument, e) || (a = C.style(e, t)), He.test(a) && Le.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 === a ? a : a + ""
        }) : N.documentElement.currentStyle && (Ae = function(e) {
            return e.currentStyle
        }, De = function(e, t, n) {
            var r, i, o, a, s = e.style;
            return null == (a = (n = n || Ae(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]), He.test(a) && !_e.test(t) && (r = s.left, (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto"
        }),
        function() {
            var e, t, n, i, o, a, s;
    ...
    function Ie(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++) {
            ...
            o[a] = C._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && I(r) && (o[a] = C._data(r, "olddisplay", je(r.nodeName)))) : (i = I(r), (n && "none" !== n || !i) && C._data(r, "olddisplay", i ? n : C.css(r, "display")))
        }
        for (a = 0; a < s; a++) {
            if (!(r = e[a]).style) continue;
    ...
    function Ue(e, t, n) {
        ...
        if (i <= 0 || null == i) {
            if (((i = De(e, t, o)) < 0 || null == i) && (i = e.style[t]), He.test(i)) return i;
    ...
    C.extend({
        ...
        style: function(e, t, n, r) {
            ...
            var i, o, a, s = C.camelCase(t),
                u = e.style;
            if (t = C.cssProps[s] || (C.cssProps[s] = ze(u, s)), a = C.cssHooks[t] || C.cssHooks[s], void 0 === n) {
                if (a && "get" in a && void 0 !== (i = a.get(e, !1, r))) return i;
                return u[t]
            }
            if ("string" === (o = typeof n) && (i = Pe.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(C.css(e, t)), o = "number"), null == n || n != n) return;
        ...
        css: function(e, t, n, r) {
            var i, o, a, s = C.camelCase(t);
            if (t = C.cssProps[s] || (C.cssProps[s] = ze(e.style, s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = De(e, t, r)), "normal" === o && t in We && (o = We[t]), "" === n || n) return i = parseFloat(o), !0 === n || C.isNumeric(i) ? i || 0 : o;
            return o
        }
    }), C.each(["height", "width"], function(e, i) {
        C.cssHooks[i] = {
            get: function(e, t, n) {
                if (t) return Fe.test(C.css(e, "display")) && 0 === e.offsetWidth ? C.swap(e, Re, function() {
                    return Ue(e, i, n)
                }) : Ue(e, i, n)
            },
            set: function(e, t, n) {
        ...
        set: function(e, t) {
            ...
            if (((n.zoom = 1) <= t || "" === t) && "" === C.trim(o.replace(Me, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter)) return;
        ...
        css: function(e, t) {
            return X(this, function(e, t, n) {
                var r, i, o = {},
                    a = 0;
                if (C.isArray(t)) {
                    for (r = Ae(e), i = t.length; a < i; a++) o[t[a]] = C.css(e, t[a], !1, r);
                    return o
                }
    ...
    var Ve, Ye, Ge, Ke, Ze, et, tt, nt = /^(?:toggle|show|hide)$/,
        rt = new RegExp("^(?:([+-])=|)(" + $ + ")([a-z%]*)$", "i"),
        it = /queueHooks$/,
        ot = [function(t, e, n) {
            ...
            1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], l = C.css(t, "display"), "inline" === ("none" === l ? C._data(t, "olddisplay") || je(t.nodeName) : l) && "none" === C.css(t, "float") && (v.inlineBlockNeedsLayout && "inline" !== je(t.nodeName) ? d.zoom = 1 : d.display = "inline-block"));
            ...
            if (C.isEmptyObject(f)) "inline" === ("none" === l ? je(t.nodeName) : l) && (d.display = l);
            else
                for (r in h ? "hidden" in h && (p = h.hidden) : h = C._data(t, "fxshow", {}), o && (h.hidden = !p), p ? C(t).show() : c.done(function() {
                    ...
                    }), f) a = lt(p ? h[r] : 0, r, c), r in h || (h[r] = a.start, p && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }],
        at = {
            "*": [function(e, t) {
    ...
    function ct(o, e, t) {
        var n, a, r = 0,
            ...
            u = function() {
                if (a) return !1;
                for (var e = Ve || st(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length; r < i; r++) l.tweens[r].run(n);
        ...
        return C.map(c, lt, l), C.isFunction(l.opts.start) && l.opts.start.call(o, l), C.fx.timer(C.extend(u, {
            elem: o,
            anim: l,
            queue: l.opts.queue
    ...
    C.Animation = C.extend(ct, {
        ...
        var e, t = C.timers,
            n = 0;
        for (Ve = C.now(); n < t.length; n++)(e = t[n])() || t[n] !== e || t.splice(n--, 1);
    ...
    }, (Ke = N.createElement("div")).setAttribute("className", "t"), Ke.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", et = Ke.getElementsByTagName("a")[0], tt = (Ze = N.createElement("select")).appendChild(N.createElement("option")), Ge = Ke.getElementsByTagName("input")[0], et.style.cssText = "top:1px", v.getSetAttribute = "t" !== Ke.className, v.style = /top/.test(et.getAttribute("style")), v.hrefNormalized = "/a" === et.getAttribute("href"), v.checkOn = !!Ge.value, v.optSelected = tt.selected, v.enctype = !!N.createElement("form").enctype, Ze.disabled = !0, v.optDisabled = !tt.disabled, (Ge = N.createElement("input")).setAttribute("value", ""), v.input = "" === Ge.getAttribute("value"), Ge.value = "t", Ge.setAttribute("type", "radio"), v.radioValue = "t" === Ge.value;
    var ft = /\r/g;
    C.fn.extend({
        val: function(n) {
            var r, e, i, t = this[0];
    ...
    var dt, pt, ht = C.expr.attrHandle,
    ...
    C.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            if (1 === o && C.isXMLDoc(e) || (t = t.toLowerCase(), r = C.attrHooks[t] || (C.expr.match.bool.test(t) ? pt : dt)), void 0 === n) return r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i;
        ...
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(D);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = C.propFix[n] || n, C.expr.match.bool.test(n) ? vt && mt || !gt.test(n) ? e[r] = !1 : e[C.camelCase("default-" + n)] = e[r] = !1 : C.attr(e, n, ""), e.removeAttribute(mt ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return !1 === t ? C.removeAttr(e, n) : vt && mt || !gt.test(n) ? e.setAttribute(!mt && C.propFix[n] || n, n) : e[C.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, C.each(C.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var o = ht[t] || C.find.attr;
        ht[t] = vt && mt || !gt.test(t) ? function(e, t, n) {
            var r, i;
            return n || (i = ht[t], ht[t] = r, r = null != o(e, t, n) ? t.toLowerCase() : null, ht[t] = i), r
        } : function(e, t, n) {
    ...
    Nt = Lt.exec(Et.toLowerCase()) || [], C.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(e, t) {
            ...
            var n, r, c, f, d, p, h, i, g = C.ajaxSetup({}, t),
                m = g.context || g,
            ...
            if (y.promise(T).complete = b.add, T.success = T.done, T.error = T.fail, g.url = ((e || g.url || Et) + "").replace(kt, "").replace(Dt, Nt[1] + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = C.trim(g.dataType || "*").toLowerCase().match(D) || [""], null == g.crossDomain && (n = Lt.exec(g.url.toLowerCase()), g.crossDomain = !(!n || n[1] === Nt[1] && n[2] === Nt[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Nt[3] || ("http:" === Nt[1] ? "80" : "443")))), g.data && g.processData && "string" != typeof g.data && (g.data = C.param(g.data, g.traditional)), Ot(Ht, g, t, T), 2 === w) return T;
            for (r in (p = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !At.test(g.type), c = g.url, g.hasContent || (g.data && (c = g.url += (Tt.test(c) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (g.url = St.test(c) ? c.replace(St, "$1_=" + wt++) : c + (Tt.test(c) ? "&" : "?") + "_=" + wt++)), g.ifModified && (C.lastModified[c] && T.setRequestHeader("If-Modified-Since", C.lastModified[c]), C.etag[c] && T.setRequestHeader("If-None-Match", C.etag[c])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && T.setRequestHeader("Content-Type", g.contentType), T.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : g.accepts["*"]), g.headers) T.setRequestHeader(r, g.headers[r]);
            ...
            function u(e, t, n, r) {
                ...
                }(g, s, T, i), i ? (g.ifModified && ((u = T.getResponseHeader("Last-Modified")) && (C.lastModified[c] = u), (u = T.getResponseHeader("etag")) && (C.etag[c] = u)), 204 === e || "HEAD" === g.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = s.state, o = s.data, i = !(a = s.error))) : (a = l, !e && l || (l = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? y.resolveWith(m, [o, l, T]) : y.rejectWith(m, [T, l, a]), T.statusCode(x), x = void 0, p && v.trigger(i ? "ajaxSuccess" : "ajaxError", [T, g, i ? o : a]), b.fireWith(m, [T, l]), p && (v.trigger("ajaxComplete", [T, g]), --C.active || C.event.trigger("ajaxStop"))
            }
            return T
        },
    ...
    }), v.cors = !!Qt && "withCredentials" in Qt, (Qt = v.ajax = !!Qt) && C.ajaxTransport(function(u) {
        var l;
            ...
            send: function(e, o) {
                ...
                a.send(u.hasContent && u.data || null), l = function(e, t) {
                    ...
                    if (l && (t || 4 === a.readyState))
                        if (delete Xt[s], l = void 0, a.onreadystatechange = C.noop, t) 4 !== a.readyState && a.abort();
                        else {
    ...
    C.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = C.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Vt, "$1" + r) : !1 !== e.jsonp && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return o || C.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", i = h[r], h[r] = function() {
            o = arguments
        }, n.always(function() {
            h[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, Jt.push(r)), o && C.isFunction(i) && i(o[0]), o = i = void 0
        }), "script"
    ...
    C.offset = {
        ...
        offset: function(t) {
            ...
            return typeof i.getBoundingClientRect !== M && (r = i.getBoundingClientRect()), n = Kt(o), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || Gt; e && !C.nodeName(e, "html") && "static" === C.css(e, "position");) e = e.offsetParent;
                return e || Gt
            })
        }
    }), C.each({
        ...
        C.cssHooks[n] = qe(v.pixelPosition, function(e, t) {
            if (t) return t = De(e, n), He.test(t) ? C(e).position()[n] + "px" : t
        })
    }), C.each({
        Height: "height",
        Width: "width"
...
function(l, n, a) {
    try {
        ...
        l.fn.init = function(e, t, n) {
            var r;
            if (e && "string" == typeof e && !l.isPlainObject(t) && (r = y.exec(l.trim(e))) && r[0] && ("#" === r[0].charAt(0) && (c("HTML string cannot start with a '#' character"), l.error("JQMIGRATE: Invalid selector string (XSS)")), t && t.context && (t = t.context), l.parseHTML)) return m.call(this, l.parseHTML(r[2], t, !0), t, n);
        ...
        }, l.browser || (t = l.uaMatch(navigator.userAgent), g = {}, t.browser && (g[t.browser] = !0, g.version = t.version), g.chrome ? g.webkit = !0 : g.webkit && (g.safari = !0), l.browser = g), e(l, "browser", l.browser, "jQuery.browser is deprecated"), l.sub = function() {
            function n(e, t) {
