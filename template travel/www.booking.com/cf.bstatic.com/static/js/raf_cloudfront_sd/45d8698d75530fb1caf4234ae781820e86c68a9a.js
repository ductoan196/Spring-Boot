...
booking.env.enable_scripts_tracking && (booking.env.scripts_tracking.raf = {
        ...
        i.exports = r.extend({
            init: function() {
                ...
                this.$toggle = this.$el.find(".friend_landing_collapsible--header"), this.$toggleIcon = this.$el.find(".friend_landing_collapsible--toggle_icon"), this.$collapse = this.$el.find(".friend_landing_collapsible-action_button"), this.isMobile = this.$el.data("is-mobile"), this.toggleCollapseClass = this.$el.data("expanded-class"), this.toggleExpandClass = this.$el.data("collapsed-class"), this.isCollapsed = !!this.$el.data("is-collapsed"), this.isCollapsedClass = this.$el.data("landing-collapsed-class"), this.collapsingDisabled = this.$el.data("collapsing-disabled"), this.collapsingDisabled || (this.$toggle.on("click", function() {
                    _i_("44d:db6abdaa"), e.isCollapsed ? e.expand() : e.collapse(), _r_()
                }), this.$collapse.on("click", function() {
                    _i_("44d:ca906f67"), e.collapse(), _r_()
                })), a.trackEvent(a.referralFriendTracker, "view", "friend_landing"), this.$el.find(".friend_landing_collapsible-tandc").on("click", function() {
                    _i_("44d:208b670a"), a.trackEvent(a.referralFriendTracker, "click", "terms_and_conditions - source: friend_landing"), _r_()
                }), _r_()
            },
            collapse: function() {
                _i_("44d:5a14237e"), this.$el.addClass(this.isCollapsedClass), this.$toggleIcon.removeClass(this.toggleCollapseClass), this.$toggleIcon.addClass(this.toggleExpandClass), this.isCollapsed = !0, a.trackEvent(a.referralFriendTracker, "collapse", "friend_landing"), _r_()
            },
            expand: function() {
                _i_("44d:9260a3a3"), this.$el.removeClass(this.isCollapsedClass), this.$toggleIcon.addClass(this.toggleCollapseClass), this.$toggleIcon.removeClass(this.toggleExpandClass), this.isCollapsed = !1, a.trackEvent(a.referralFriendTracker, "expand", "friend_landing"), _r_()
            }
        }), _r_()
        ...
        r.prototype.copy = function(e, n) {
            _i_("44d:b9e312de"), this.text = e, this.isRTL = B.env.b_lang_rtl, "function" == typeof n && (this.copyCallback = n), this.selectFake(), _r_()
        }, r.prototype.selectFake = function() {
            _i_("44d:563ce6c9"), this.removeFake();
            ...
            e.style.top = n + "px", e.setAttribute("readonly", ""), e.value = this.text, document.body.appendChild(e),
                function(e) {
                    var n;
                    if (_i_("44d:eed13d9d"), "SELECT" === e.nodeName) e.focus(), n = e.value;
                        ...
                        a.selectNodeContents(e), r.removeAllRanges(), r.addRange(a), n = r.toString()
                    }
                    _r_(n)
                }(e), this.copyText(), _r_()
        }, r.prototype.removeFake = function() {
            _i_("44d:dcba3dac"), this.fakeElement && (document.body.removeChild(this.fakeElement), this.fakeElement = null), _r_()
            ...
            this.handleResult(n), _r_()
        }, r.prototype.handleResult = function(e) {
            _i_("44d:14c14746"), this.copyCallback && (e ? this.copyCallback(null) : this.copyCallback(!0)), this.removeFake(), _r_()
        }, i.exports = new r, _r_()
        ...
        i.exports = e("component").extend({
            init: function() {
                ...
                this.isPartnerProgram = this.$el.is("[data-is-partner-program]"), this.isShowCompliment = this.$el.is("[data-show-compliment]"), this.$emailShare = this.$el.find(".js-raf-share-email"), this.$emailShare.on("click", function() {
                    _i_("44d:1c8d4064"), r.triggerGoal("share_email", this.isPartnerProgram ? "click email mobile button" : "click email button"), _r_()
                }), this.$gmailShare = this.$el.find(".js-raf-share-gmail"), this.$gmailShare.on("click", function() {
                    _i_("44d:1b612da0"), r.triggerGoal("share_gmail", "click gmail button"), _r_()
                }), this.$fbShare = this.$el.find(".js-raf-share-facebook"), this.$fbShare.on("click", function(e) {
                    _i_("44d:061c0e26"), e.preventDefault(), r.showPopupWindow($(this).attr("href"), "Share", 480, 320), r.triggerGoal("share_facebook", "click facebook button"), _r_()
                }), this.$twShare = this.$el.find(".js-raf-share-twitter"), this.$twShare.on("click", function(e) {
                    _i_("44d:0b0d8550"), e.preventDefault(), r.triggerGoal("share_twitter", "click twitter button"), r.showPopupWindow($(this).attr("href"), "Share", 480, 320), _r_()
                }), this.$el.find(".raf-scoreboard--link").on("click", function(n) {
                    _i_("44d:2f7ad4a8");
                    var e = $(this).val();
                    o.copy(e, function(e) {
                        if (_i_("44d:bce39a05"), e) return _r_(!1);
                        r.triggerGoal("share_copy"), r.$urlShare.text(r.$urlShare.data("success-copy")), n.target.select(), _r_()
                    }), _r_()
                }), this.$el.find(".raf-scoreboard--link").on("copy", function() {
                    _i_("44d:4b58d24c"), _.trackEvent(_.referralAdvocateTracker, "copy link", "myreferrals"), _r_()
                }), this.$urlShare = this.$el.find(".js-raf-share-copy"), this.$urlShare.on("click", function(e) {
                    _i_("44d:da57e023");
                    var n = r.$urlShare.data("share-link"),
                        i = t.get(a);
                    e.preventDefault(), o.copy(n, function(e) {
                        if (_i_("44d:038f8483"), e) return _r_(!1);
                        r.triggerGoal("share_copy"), i ? (i.show(), setTimeout(function() {
                            var e;
                            _i_("44d:d5add9e4"), e = i, _i_("44d:73af4510"), e && e.hide && e.hide(), _r_(), _r_()
                        }, 1e3)) : r.$urlShare.text(r.$urlShare.data("success-copy")), _r_()
                    }), _.trackEvent(_.referralAdvocateTracker, "share - source: " + B.env.b_action, "click url button"), _r_()
                }), this.$whatsappShare = this.$el.find(".js-raf-share-whatsapp"), this.$whatsappShare.on("click", function() {
                    _i_("44d:364e4520"), r.triggerGoal("share_whatsapp", "click whatsapp button"), _r_()
                }), this.$linkedinShare = this.$el.find(".js-raf-share-linkedin"), this.$linkedinShare.on("click", function() {
                    _i_("44d:ba038609"), r.triggerGoal("share_linkedin", "click linkedin button"), _r_()
                    ...
                    _i_("44d:04de4611"), r.triggerGoal("share_messenger", "click messenger button"), "undefined" != typeof FB && void 0 !== FB.ui && (e.preventDefault(), n || (n = $(this).data("share-link")), FB.ui({
                        method: "send",
                        link: n
                    })), _r_()
                }), _r_()
            ...
            triggerGoal: function(e, n) {
                _i_("44d:201f4c6e"), this.isPartnerProgram ? a.shareGoal(e) : r.shareGoal("gm_" + e), n && _.trackEvent(this.isPartnerProgram ? _.referralPartnerAdvocateTracker : _.referralAdvocateTracker, "share - source: " + B.env.b_action, n), _r_()
            }
        }), _r_()
        ...
        var r, a = e("component"),
            ...
            o = e("jquery"),
            s = B.env,
            d = e("browser-storage-handler"),
            l = e("events"),
            c = e("jstmpl"),
            u = !1,
            p = e("component/referral/name-reward-copy-logic/dynamic-tag-copy-logic"),
            m = "raf_landing_modal_opened";
        "www" === s.b_site_type && "index" === s.b_action && (r = e("ultrafocus").getInstance("raf_landing", "[data-sb-outer],[data-raf-widget]")), booking.jstmpl("friend_landing_card", function() {
            _i_("44d:2c11e6b3");
            ...
            return _r_(function(e) {
                ...
                var n, i, r = "",
                    a = this.fn;
                return r += t[0], n = r, _i_("44d:725ec633"), a.MJ(a.MB(o[3])) && (n += t[1], e.unshift({
                    fe_warning_message_body: a.MB(o[2]),
                    fe_warning_message_header: a.MB(o[1])
                }), i = n, _i_("44d:dd764c99"), i += [t[2], "", t[3], a.F.entities(a.MC(o[0])), t[4], (e.unshift({
                    height: t[5],
                    name: t[6],
                    width: t[5]
                }), _ = a.HELPER("icon", e[0]), e.shift(), _), t[7]].join(""), a.MD(o[1]) && (i += [t[8], (e.unshift({
                    color: "#CD8900",
                    height: t[9],
                    name: t[10],
                    width: t[9]
                }), _ = a.HELPER("icon", e[0]), e.shift(), _), t[11], a.MC(o[1]), t[12]].join("")), i += [t[13], a.MC(o[2]), t[14], "", t[15]].join(""), n = _r_(i), e.shift(), n += t[15]), n += t[16], a.MD(o[5]) ? (n += t[17], a.MJ(a.MB(o[5])) && a.MJ(a.MC(o[6])) ? n += [t[11], a.F.entities(a.MC(o[4])), t[17]].join("") : n += [t[11], a.F.entities(a.MC(o[7])), t[17]].join(""), n += t[18]) : n += [t[17], (e.unshift({
                    value: a.MB(o[8])
                }), _ = a.ME(t[19], a.MB, a.MN, null), e.shift(), _), t[18]].join(""), n += t[20], a.MJ(a.MB(o[5])) && a.MJ(a.MC(o[6])) ? (n += t[17], a.MD(o[10]) ? n += [t[11], a.F.entities(a.MC(o[9])), t[17]].join("") : n += [t[11], a.F.entities(a.MC(o[11])), t[17]].join("")) : (n += t[17], a.MD(o[12]) ? n += [t[11], (e.unshift({
                    friend_name: a.MB(o[12])
                }), _ = a.ME(t[21], a.MB, a.MN, null), e.shift(), _), t[17]].join("") : n += [t[11], a.ME(t[22], a.MB, a.MN, null), t[17]].join("")), n += t[18], n += t[23], a.MN(o[13], a.ME(t[24], a.MB, a.MN, null)), n += t[0], a.MN(o[14], a.ME(t[25], a.MB, a.MN, null)), n += t[0], a.MN(o[15], a.ME(t[26], a.MB, a.MN, null)), n += t[27], a.MD(o[5]) && (n += t[28], a.MN(o[13], a.ME(t[24], a.MB, a.MN, null)), n += t[18], a.MN(o[14], a.ME(t[25], a.MB, a.MN, null)), n += t[18], a.MN(o[15], a.F.entities(a.MC(o[16]))), n += t[0]), n += [t[29], a.MC(o[13]), t[30], a.STATIC_HOSTNAME("/static/img/referral/raf-gift-heart-decorated.svg", 0, 0, 0, 0), t[31], a.MC(o[14]), t[32], a.STATIC_HOSTNAME("/static/img/referral/raf-booking-property.svg", 0, 0, 0, 0), t[33], a.MC(o[15]), t[30], a.STATIC_HOSTNAME("/static/img/referral/raf-wallet-gift.svg", 0, 0, 0, 0), t[34]].join(""), a.MJ(a.MC(o[18]) + "" == "www") && (n += [t[35], a.MC(o[17]), t[36]].join("")), n += t[37], a.MJ(a.MB(o[5])) && a.MK(a.MC(o[6])) ? n += [t[38], a.F.entities(a.MC(o[19])), t[39], a.ME(t[40], a.MB, a.MN, null), t[41]].join("") : (n += t[17], a.MJ(a.MB(o[5])) && a.MJ(a.MC(o[6])) ? (n += t[11], a.MD(o[10]) ? n += [t[42], a.F.entities(a.MC(o[20])), t[43], a.ME(t[44], a.MB, a.MN, null), t[45]].join("") : n += [t[46], a.ME(t[47], a.MB, a.MN, null), t[48]].join(""), n += t[17]) : (n += t[49], a.MD(o[22]) ? n += a.F.entities(a.MC(o[21])) : n += t[50], n += [t[51], a.ME(t[52], a.MB, a.MN, null), t[53]].join("")), n += t[18]), n += t[54], r = _r_(n), r += t[1], _r_(r)
            })
        }());
        var f = function() {
            _i_("44d:b5e0eafd"), o(".raf-widget--hidden").removeClass("raf-widget--hidden"), _r_()
        };
        i.exports = a.extend({
            init: function() {
                _i_("44d:7f82f564"), l.on("raf-warning-hide", function() {
                    _i_("44d:a146b57b"), _.rePosition(), _r_()
                }), this.doGaStuff(), this.bindExternalEvents();
                var e = this;
                window.setTimeout(function() {
                    if (_i_("44d:7796f050"), e.shouldSkipLightbox()) return f(), _r_();
                    e.bindEvents(), e.renderLightbox(), _r_()
                }, 300), _r_()
            },
            bindExternalEvents: function() {
                ...
                booking.eventEmitter.on("account-onboarding-modal-show", function() {
                    _i_("44d:599b6801"), u = !0, _r_()
                }), l.on("onboarding-lightbox-dismissed", function() {
                    _i_("44d:2afea17a"), u = !1, window.setTimeout(function() {
                        _i_("44d:77a78e55"), _.isVisible() || e.init(), _r_()
                    }, 100), _r_()
                }), _r_()
            },
            bindEvents: function() {
                var e;
                (_i_("44d:9f829f3f"), o("body").on("click", ".js-close-friend-landing-lightbox", this.closeLightbox), void 0 !== r) && (r.on("ultrafocus::shown", function() {
                    _i_("44d:c3af9a61"), o("#ss").focus(), e = window.setTimeout(function() {
                        _i_("44d:68f0f3a9"), o("#raf-widget-text-container").addClass("expanded"), _r_()
                    }, 3e3), _r_()
                }), r.on("ultrafocus::hidden", function() {
                    _i_("44d:941125aa"), window.clearTimeout(e), _r_()
                }));
                _r_()
            },
            renderLightbox: function() {
                ...
                _i_("44d:ada225d4"), o(".raf-widget, .raf-widget-text-container").addClass("raf-widget--hidden"), _r_();
                var r = {
                    autoWidth: !1,
                    ...
                    positionAfterCallBack: function() {
                        _i_("44d:f64ef655"), t.trackEvent(t.referralFriendTracker, "show", "Friend Landing Lightbox"), _r_()
                    },
                    hideCallBack: function() {
                        _i_("44d:2b257c9a"), B.env.referral_data.rafForceLogin || (t.trackEvent(t.referralFriendTracker, "dismiss", "Friend Landing Lightbox"), d.addSessionValue(m, 1)), f(), _r_()
                    }
                };
                s.referral_data.rafForceLogin && (r.bCloseButton = !1, r.bMaskClick = !1, r.closeOnEsc = !1);
                var a = _.show(e.render(i), r);
                a && a.loadComponents && a.loadComponents(), _r_()
            },
            closeLightbox: function(e) {
                if (_i_("44d:4fe58a90"), e.preventDefault(), t.trackEvent(t.referralFriendTracker, "click", "Friend Landing Lightbox"), !B.env.referral_data.rafForceLogin)
                    if ("www" == B.env.b_site_type || "tdot" == B.env.b_site_type) {
                        ...
                        s.rtl ? n.css({
                            ...
                            _i_("44d:7eee06191"), _.hide(), _r_()
                        })
                    } else _.hide();
                void 0 === r || B.env.referral_data.rafForceLogin || r.show(), _r_()
            },
            shouldSkipLightbox: function() {
                return _i_("44d:a93e2ba9"), _r_(!B.env.b_is_landing && d.getSessionValue(m) && !s.b_raf_li_in && !s.b_raf_prop_ne || s.referral_data.is_incentive_campaign || s.referral_data.b_has_raf_link_saved_in_account && "89" == s.referral_data.raf_source || u)
            },
            switchView: function(e) {
                _i_("44d:ccdef575");
                var n = o("#" + e).html();
                o(".raf-friend-landing-card__content").addClass("raf-sfl-view-wrapper").html(n), _.rePosition(), _r_()
            },
            saveForLater: function() {
                _i_("44d:342dc764"), o.ajax({
        ...
        i.exports = {
            shareGoal: function(e) {
                _i_("44d:53c28dcd"), r.goal(e), r.goal("gm_share"), _r_()
            }
        }, _r_()
        ...
        i.exports = {
            shareGoal: function(e) {
                _i_("44d:2cd92b4e"), r.goal("grap_share"), _r_()
            }
        }, _r_()
    }),
    function(p) {
        ...
        function m(e) {
            _i_("44d:92f30a71"), p.reportError(new Error(e), "raf:copy-input"), _r_()
        }
            ...
            i.exports = r.extend({
                init: function() {
                    ...
                    var i = this,
                        ...
                        o = t.val();
                    if (!t.get(0)) return m("Share link node is missing"), _r_();
                    if (!e.get(0)) return m("Share btn node is missing"), _r_();
                    if (!o) return m("RAF share links is missing"), _r_();

                    function s() {
                        _i_("44d:35202ca9");
                        var e = i.$el.data("tooltip-id"),
                            n = a.get(e);
                        if (!n) return m('Tooltip with id "' + e + '" is missing'), _r_();
                        n.show(), setTimeout(function() {
                            _i_("44d:ce2c5886"), n.hide(), _r_()
                        }, 1e3), _r_()
                    }

                    function d() {
                        _i_("44d:43c5560b"), n ? (u.trackEvent(u.referralPartnerAdvocateTracker, "share - source: " + p.env.b_action, "click copy"), c.shareGoal("share_copy")) : _.shareGoal("gm_share_copy"), _r_()
                    }
                    e.add(t).on("click", function(e) {
                        if (_i_("44d:4a7ebd46"), e.preventDefault(), navigator.userAgent.match(/ipad|ipod|iphone/i)) {
                            var n = t.get(0),
                                i = n.contentEditable,
                                r = n.readOnly;
                            ...
                            _.removeAllRanges(), _.addRange(a), n.setSelectionRange(0, 999999), n.contentEditable = i, n.readOnly = r, document.execCommand("copy"), t.blur(), s(), d()
                        } else l.copy(o, function(e) {
                            if (_i_("44d:3fc4dc86"), t.select(), e) return _r_();
                            s(), d(), _r_()
                        }.bind(this));
                        _r_()
                    }), _r_()
    ...
    }(window.B), B.define("component/referral/ribbon", function(e, n, i) {
        _i_("44d:085955f7");
        var r = e("component"),
            a = e("jquery"),
            _ = e("ga-tracker"),
        ...
        if (o) var s = e("ultrafocus").getInstance("raf_ribbon", "[data-sb-outer]");
        var d = "-collapsed";
        i.exports = r.extend({
            init: function() {
                _i_("44d:9648204f");
                var e = this;
                (this.searchInput = a("#ss"), this._onToggleClickBinded = this.onToggleClick.bind(this), this._onRibbonClickBinded = this.onRibbonClick.bind(this), this.$el.on("click", this._onRibbonClickBinded), this.$toggle = this.$el.find(".referral_ribbon--toggle"), this.$toggle.on("click", this._onToggleClickBinded), o) && (s.on("ultrafocus::shown", function() {
                    _i_("44d:f665ceda"), e.searchInput && e.searchInput.focus(), _r_()
                }), B.require("search/searchbox/searchbox-sticky-controller").getController().on("show", function() {
                    _i_("44d:ecb191ee"), s.hide(), _r_()
                }));
                this.$actionButton = this.$el.find(".referral_ribbon--button"), this.$actionButton.on("click", function(e) {
                    _i_("44d:8aaed789"), e.stopPropagation(), this.collapse(), o && s.show(), _.trackEvent(_.referralFriendTracker, "click", "start-searching button on ribbon"), _r_()
                }.bind(this)), this.$el.find(".referral_ribbon--terms a").on("click", function() {
                    _i_("44d:37900131"), _.trackEvent(_.referralFriendTracker, "click", "term_and_conditions - source: ribbon on" + B.env.b_action), _r_()
                }), t.on("incentives:campaignExpired", function() {
                    _i_("44d:10d5b5fa"), this.$el.remove(), _r_()
                }.bind(this)), _r_()
            },
            onToggleClick: function(e) {
                _i_("44d:d81ac054"), e.stopPropagation(), this.collapse(), _r_()
            },
            onRibbonClick: function(e) {
                _i_("44d:88cd48cb"), this.$el.hasClass(d) && (e.stopPropagation(), this.expand(), this.$el.off("click", this._onRibbonClickBinded), this.$toggle.on("click", this._onToggleClickBinded)), _r_()
            },
            collapse: function() {
                _i_("44d:1277b34c"), this.$el.addClass(d), this.$toggle.off("click", this._onToggleClickBinded), this.$el.on("click", this._onRibbonClickBinded), _.trackEvent(_.referralFriendTracker, "collapse", "ribbon"), _r_()
            },
            expand: function() {
                _i_("44d:8865cd7b"), this.$el.removeClass(d), _.trackEvent(_.referralFriendTracker, "expand", "ribbon"), _r_()
            }
        }), _r_()
        ...
        i.exports = e("component").extend({
            init: function() {
                _i_("44d:642d9e6e"), $(document.documentElement).addClass("raf-ribbon-presents"), this.$el.on("click", function() {
                    _i_("44d:1ae5e5bf"), r.trackEvent(r.referralFriendTracker, "click", "ribbon-green"), _r_()
                }.bind(this)), this.$el.on("mouseover", function() {
                    _i_("44d:750d0fea"), r.trackEvent(r.referralFriendTracker, "hover", "ribbon-green"), _r_()
                }.bind(this)), _r_()
            }
        }), _r_()
    }), B.define("component/referral/raf-widget", function(e, n, i) {
        _i_("44d:4fedf566"), i.exports = e("component").extend({
            init: function() {
                _i_("44d:0d45f1fb");
                ...
                n.on("click", function() {
                    _i_("44d:de2eb1da"), e.toggleClass("expanded"), _r_()
                });
                var r = e.data("expandAfter");
                r && 0 < +r && !i && window.setTimeout(function() {
                    _i_("44d:ec766fba"), e.addClass("expanded"), _r_()
                }, +r), _r_()
            }
        }), _r_()
        ...
        function u(e, n) {
            if (_i_("44d:d4b0c3f9"), n) return _r_("employee");
            if (e.b_campaign_details.b_is_discount_campaign) return _r_("percent");
            return _r_("fixed")
        }

        function p(e, n) {
            return _i_("44d:6886ec45"), _r_(n ? e.b_campaign_details.b_raf_reward_type_friend : e.b_campaign_details.b_raf_reward_type_advocate)
        }

        function m(e) {
            if (_i_("44d:46d2fa3b"), e.advocate_name) return _r_("name");
            return _r_("noname")
        }
        ...
        function f(e, n) {
            _i_("44d:77edce6d");
            var i = null;
            return i = n ? e.b_campaign_details.b_raf_reward_advocate : e.b_campaign_details.b_is_discount_campaign ? e.b_campaign_details.b_raf_reward_friend_percentage : e.b_campaign_details.b_raf_reward_friend, _r_(i)
        }
        i.exports = {
            translate: function(e) {
                ...
                var n = e.fe_raf_campaign_details_fragment_output,
                    ...
                    d = null,
                    l = null;
                if (r && a && _) return o = u(n, t), s = p(n, t), d = m(n), l = f(n, t), _r_(c.translations(i + "_" + o + "_" + s + "_" + d, l, {
                ...
                if (r && a) return o = u(n, t), s = p(n, t), l = f(n, t), _r_(c.translations(i + "_" + o + "_" + s, l, {
                    value_percent_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_percentage,
                    value_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_with_currency,
                    minimum_spend: n && n.b_campaign_details && n.b_campaign_details.b_raf_min_qualifying_amount_campaign_currency
                }));
                if (a && _) return s = p(n, t), d = m(n), _r_((c.translations(i + "_" + s + "_" + d), {
                    advocate_name: n.advocate_name,
                    value_percent_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_percentage,
                    value_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_with_currency,
                    minimum_spend: n && n.b_campaign_details && n.b_campaign_details.b_raf_min_qualifying_amount_campaign_currency
                }));
                if (r && _) return o = u(n, t), d = m(n), l = f(n, t), _r_(c.translations(i + "_" + o + "_" + d, l, {
                    advocate_name: n.advocate_name
                }));
                if (r) return o = u(n, t), l = f(n, t), _r_(c.translations(i + "_" + o, l, {
                    value_percent_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_percentage,
                    value_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_with_currency
                }));
                if (a) return s = p(n, t), _r_(c.translations(i + "_" + s, null, {
                    value_percent_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_percentage,
                    value_friend: n && n.b_campaign_details && n.b_campaign_details.b_raf_reward_friend_with_currency,
                    minimum_spend: n && n.b_campaign_details && n.b_campaign_details.b_raf_min_qualifying_amount_campaign_currency
                }));
                if (_) return d = m(n), _r_(c.translations(i + "_" + d, null, {
                    advocate_name: n.advocate_name
                }));
                _r_()
            }
        ...
        i.exports = r.extend({
            init: function() {
                _i_("44d:57a957ef"), B.command("show-auth-lightbox").run({
                    tab: "register",
        ...
        booking.jstmpl("invalid_link_card", function() {
            ...
            return _r_(function(e) {
                ...
                var n, i = "",
                    r = this.fn;
                return i += _[0], n = i, _i_("44d:669836af"), n += _[1], r.MJ(r.MC(t[0]) + "" == "user_not_logged_in") ? n += _[2] : (n += _[3], r.MJ(1 == r.MC(t[1])) ? n += [_[4], r.ME(_[5], r.MB, r.MN, null), _[6]].join("") : r.MJ(1 == r.MC(t[2])) && (n += [_[4], r.ME(_[7], r.MB, r.MN, null), _[6]].join("")), n += [_[8], r.STATIC_HOSTNAME("/static/img/referral/raf-failure.svg", 0, 0, 0, 0), _[9], r.ME(_[10], r.MB, r.MN, null), _[11], (e.unshift({
                    name: _[12],
                    size: _[13]
                }), a = r.HELPER("icon", e[0]), e.shift(), a), _[14]].join("")), i = _r_(n), i += _[15], _r_(i)
            })
        }()), i.exports = r.extend({
            init: function() {
                _i_("44d:16a9c65b");
        ...
        _i_("44d:d92c1523"), booking.jstmpl("ribbon", function() {
            ...
            var s, d = ['<div\n    class="\n        rewards-ribbon\n        ', "-expanded", "-collapsed", "\n        ", "-top", '\n    "\n>\n\n    ', '\n        <button type="button" class="rewards-ribbon__icon-btn" aria-label="', "/private/a11y_cta_close/name", '">\n            ', "iconset/close", "presentation", "24", "\n        </button>\n    ", "\n\n    ", '\n        <button on:click="toggleExpandContent" type="button" class="rewards-ribbon__icon-btn">\n            ', "\n                ", "iconset/navarrow_down", "\n            ", "iconset/navarrow_up", '\n\n    <div class="rewards-ribbon__collapsed">\n        ', '\n            <img class="rewards-ribbon__img" src="', '" alt=""/>\n        ', '\n            <div class="rewards-ribbon__icon">\n                ', "streamline/coupon_discount", "\n            </div>\n        ", '\n        <div class="rewards-ribbon__collapsed-content">\n            <div class="rewards-ribbon__collapsed-title">', '</div>\n        </div>\n    </div>\n\n    <div class="rewards-ribbon__expanded">\n\n        ', '\n\n            <div class="rewards-ribbon__expanded-title-wrapper">\n                ', '\n                    <img class="rewards-ribbon__img" src="', '" alt=""/>\n                ', '\n                    <div class="rewards-ribbon__icon">\n                        ', "\n                    </div>\n                ", '\n                <div class="rewards-ribbon__expanded-title">', '</div>\n            </div>\n\n            <div class="rewards-ribbon__expanded-content">\n                <div class="rewards-ribbon__expanded-subtitle">\n\n                    ', "\n\n                    ", '\n\n                        <span class="rewards-ribbon__terms-link">\n                            <span class="bui-link" data-bui-component="Modal" data-modal-id="rewards-terms-popover" aria-label="', "/private/rewards_a11y_promo_code_more_details_open/name", '">\n                                ', "/private/reward_mini_tcs_entry_point_more_info/name", "\n                            </span>\n                        </span>\n\n                        ", '\n    <template id="rewards-terms-popover">\n        <header class="bui-modal__header rewards-terms-popover">\n            ', "\n    <h3>\n        ", "/private/reward_mini_tcs_title/name", "\n    </h3>\n    <ol>\n        ", "\n            <li>", "</li>\n        ", "\n\n        ", "\n\n    </ol>\n", '\n            <p class="bui-modal__paragraph bui-u-margin-top--16">\n                <a href="', '" target="_blank" class="bui-link bui-link--primary">\n                    ', '\n                </a>\n            </p>\n        </header>\n        <footer class="bui-modal__footer">\n            <div class="bui-group bui-group--inline">\n                <button type="button" class="bui-button bui-button--primary" data-bui-ref="modal-close">\n                    <span class="bui-button__text">', "/private/incentives_engage_reward_modal_got_it_cta/name", "</span>\n                </button>\n            </div>\n        </footer>\n    </template>\n", '\n    <div id="rewards-terms-popover" class="bui-panel bui-u-hidden rewards-terms-popover">\n        ', '\n        <p class="bui-modal__paragraph bui-u-margin-top--16">\n            <a href="', '" target="_blank" class="bui-link bui-link--primary">\n                ', "\n            </a>\n        </p>\n    </div>\n", "\n\n", "\n\n                </div>\n\n                ", '\n    <span class="rewards-ribbon__link">\n        <span class="bui-link ', "bui-link--primary", "\n        </span>\n    </span>\n", '\n    <span class="rewards-ribbon__link">\n        <a class="bui-link ', '" href="', "\n        </a>\n    </span>\n", "\n", '\n    <button class="rewards-ribbon__cta bui-button bui-button--', "secondary", '" type="button">\n        <span class="bui-button__text">', "</span>\n    </button>\n", '\n    <a class="rewards-ribbon__cta bui-button bui-button--', '">\n        <span class="bui-button__text">', "</span>\n    </a>\n", "\n\n\n", "\n\n            </div>\n\n        ", "\n\n            ", '\n                <img class="rewards-ribbon__img" src="', '" alt=""/>\n            ', '\n                <div class="rewards-ribbon__icon">\n                    ', "\n                </div>\n            ", '\n\n            <div class="rewards-ribbon__expanded-content">\n\n                <div class="rewards-ribbon__expanded-title">', '</div>\n                <div class="rewards-ribbon__expanded-subtitle">', "</div>\n\n                ", '\n\n                <span class="rewards-ribbon__terms-link">\n                    <span\n                        class="bui-link"\n                        data-bui-component="Popover"\n                        data-popover-content-id="rewards-terms-popover"\n                        ', '\n                            data-popover-position="bottom"\n                        ', '\n                            data-popover-position="top"\n                        ', '\n                        tabindex="0"\n                    >\n\n                        ', "\n\n                    </span>\n                </span>\n\n                ", "\n\n                ", "\n    </div>\n\n</div>"],
                l = ["is_container_expanded", "placement", "is_close_button_visible", "site_type", "is_toggle_button_visible", "icon", "copy", "url", "is_more_info_visible", "link_action", "cta_1_type", "cta_1_action", "cta_2_type", "cta_2_action"];
            return _r_(function(e) {
                _i_("44d:c94e78a5");
                var n, i = "",
                    r = this.fn;
                ...
                function a(e) {
                    return _i_("44d:438a090a"), r.MJ(r.MB(l[3]) + "" == "mdot") ? (e = o(e += d[40]), e += [d[48], r.F.entities((r.MC(l[7]) || {}).terms), d[49], r.F.entities(((r.MC(l[6]) || {}).terms || {}).terms_link), d[50], r.ME(d[51], r.MB, r.MN, null), d[52]].join("")) : (e = o(e += d[53]), e += [d[54], r.F.entities((r.MC(l[7]) || {}).terms), d[55], r.F.entities(((r.MC(l[6]) || {}).terms || {}).terms_link), d[56]].join("")), e += d[57], _r_(e)
                }

                function _(e) {
                    return _i_("44d:fd9fc9a3"), r.MD(l[9]) ? (e += d[59], r.MJ(r.MB(l[3]) + "" == "mdot") && (e += d[60]), e += [d[8], r.F.entities((r.MC(l[6]) || {}).link), d[61]].join("")) : r.MJ(r.MG((r.MC(l[7]) || {}).link)) && (e += d[62], r.MJ(r.MB(l[3]) + "" == "mdot") && (e += d[60]), e += [d[63], r.F.entities((r.MC(l[7]) || {}).link), d[8], r.F.entities((r.MC(l[6]) || {}).link), d[64]].join("")), e += d[65], _r_(e)
                }

                function t(e) {
                    return _i_("44d:0fe64431"), e += d[65], r.MD(l[11]) ? (e += d[66], r.MD(l[10]) ? e += r.F.entities(r.MC(l[10])) : e += d[67], e += [d[68], r.F.entities((r.MC(l[6]) || {}).cta_1), d[69]].join("")) : r.MJ(r.MG((r.MC(l[7]) || {}).cta_1)) && (e += d[70], r.MD(l[10]) ? e += r.F.entities(r.MC(l[10])) : e += d[67], e += [d[63], r.F.entities((r.MC(l[7]) || {}).cta_1), d[71], r.F.entities((r.MC(l[6]) || {}).cta_1), d[72]].join("")), e += d[73], r.MD(l[13]) ? (e += d[66], r.MD(l[12]) ? e += r.F.entities(r.MC(l[12])) : e += d[67], e += [d[68], r.F.entities((r.MC(l[6]) || {}).cta_2), d[69]].join("")) : r.MJ(r.MG((r.MC(l[7]) || {}).cta_2)) && (e += d[70], r.MD(l[12]) ? e += r.F.entities(r.MC(l[12])) : e += d[67], e += [d[63], r.F.entities((r.MC(l[7]) || {}).cta_2), d[71], r.F.entities((r.MC(l[6]) || {}).cta_2), d[72]].join("")), e += d[65], _r_(e)
                }

                function o(e) {
                    return _i_("44d:219b4342"), e += [d[41], r.ME(d[42], r.MB, r.MN, null), d[43]].join(""), r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).reward)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).reward), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).minimum_spend)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).minimum_spend), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).expiration_date)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).expiration_date), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).platform)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).platform), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).maximum_reward)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).maximum_reward), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).payback)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).payback), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).payback_after_checkout)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).payback_after_checkout), d[45]].join("")), e += d[46], r.MJ(r.MG(((r.MC(l[6]) || {}).terms || {}).full_tncs_apply)) && (e += [d[44], r.F.entities(((r.MC(l[6]) || {}).terms || {}).full_tncs_apply), d[45]].join("")), e += d[47], _r_(e)
                }
                return n = i, _i_("44d:56855a66"), n += d[0], r.MD(l[0]) ? n += d[1] : n += d[2], n += d[3], r.MJ(r.MB(l[1]) + "" == "top") && (n += d[4]), n += d[5], r.MD(l[2]) && (n += [d[6], r.ME(d[7], r.MB, r.MN, null), d[8], (e.unshift({
                    name: d[9],
                    role: d[10],
                    width: d[11]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[12]].join("")), n += d[13], r.MD(l[4]) && (n += d[14], r.MJ(r.MB(l[3]) + "" == "mdot") ? n += [d[15], (e.unshift({
                    name: d[16],
                    role: d[10],
                    width: d[11]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[17]].join("") : n += [d[15], (e.unshift({
                    name: d[18],
                    role: d[10],
                    width: d[11]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[17]].join(""), n += d[12]), n += d[19], r.MJ(r.MG((r.MC(l[5]) || {}).image_url)) ? n += [d[20], r.F.entities((r.MC(l[5]) || {}).image_url), d[21]].join("") : n += [d[22], (e.unshift({
                    color: "#FF8000",
                    name: d[23]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[24]].join(""), n += [d[25], r.F.entities((r.MC(l[6]) || {}).title_collapsed), d[26]].join(""), r.MJ(r.MB(l[3]) + "" == "mdot") ? (n += d[27], r.MJ(r.MG((r.MC(l[5]) || {}).image_url)) ? n += [d[28], r.F.entities((r.MC(l[5]) || {}).image_url), d[29]].join("") : n += [d[30], (e.unshift({
                    color: "#FF8000",
                    name: d[23]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[31]].join(""), n += [d[32], r.F.entities((r.MC(l[6]) || {}).title_expanded), d[33], r.F.entities((r.MC(l[6]) || {}).subtitle), d[34]].join(""), r.MD(l[8]) && (n = a(n += [d[35], r.ME(d[36], r.MB, r.MN, null), d[37], r.ME(d[38], r.MB, r.MN, null), d[39]].join("")), n += d[34]), n = _(n += d[58]), n = t(n += d[15])) : (n += d[75], r.MJ(r.MG((r.MC(l[5]) || {}).image_url)) ? n += [d[76], r.F.entities((r.MC(l[5]) || {}).image_url), d[77]].join("") : n += [d[78], (e.unshift({
                    color: "#FF8000",
                    name: d[23]
                }), s = r.HELPER("icon", e[0]), e.shift(), s), d[79]].join(""), n = t(n += d[75]), n += [d[80], r.F.entities((r.MC(l[6]) || {}).title_expanded), d[81], r.F.entities((r.MC(l[6]) || {}).subtitle), d[82]].join(""), r.MD(l[8]) && (n += d[83], r.MJ(r.MB(l[1]) + "" == "top") ? n += d[84] : n += d[85], n = a(n += [d[86], r.ME(d[38], r.MB, r.MN, null), d[87]].join("")), n += d[88]), n = _(n += d[88])), n += d[74], n += d[89], i = _r_(n), _r_(i)
            })
        }());
        ...
        n.exports = i.extend({
            ...
            afterRender: function() {
                _i_("44d:51009026"), this.BUI = window.BUI, this.BUI && this.BUI.initComponents && this.BUI.initComponents(this.el), _r_()
            },
            toggleExpandContent: function() {
                _i_("44d:7c265c25"), this.setState({
        ...
        _i_("44d:12eee515"), booking.jstmpl("landing_modal", function() {
            _i_("44d:8b15f993");
            ...
            p = {
                ...
                copy: {
                    ...
                    list: [].concat([_.fe_rewards_landing_copy_sr_point_1, _.fe_rewards_landing_copy_sr_point_2, _.fe_rewards_landing_copy_sr_point_3, _.fe_rewards_landing_copy_sr_point_4]).filter(function(e) {
                        return _i_("44d:183103b5"), _r_(0 != e)
                    }),
        ...
        n.exports = i.extend({
            ...
            initialize: function() {
                _i_("44d:4b875bbc");
                var e, n = this.getState(),
                    i = window.BUI,
                    r = this;
                n.should_use_ultrafocus && (e = a("ultrafocus").getInstance("rewards-landing", "[data-sb-outer]")), this.modal = i.createInstance("Modal", document.createElement("div"), {
                    id: "rewards-landing",
                    onBeforeOpen: function() {
                        _i_("44d:8a9e497c"), n.can_copy_reward_token && this.modalEl.querySelector(".js-copy-modal") && this.modalEl.querySelector(".js-copy-modal").addEventListener("click", r.copyRewardToken.bind(r)), this.modalEl.querySelector(".js-main-cta") && this.modalEl.querySelector(".js-main-cta").addEventListener("click", r.mainCTACloseAction.bind(r)), this.modalEl.querySelector(".js-secondary-cta") && this.modalEl.querySelector(".js-secondary-cta").addEventListener("click", r.trackCTAclick.bind(r)), _r_()
                    },
                    onAfterClose: function() {
                        _i_("44d:b98b4e0d"), n.can_copy_reward_token && this.modalEl.querySelector(".js-copy-modal") && this.modalEl.querySelector(".js-copy-modal").removeEventListener("click", r.copyRewardToken.bind(r)), this.modalEl.querySelector(".js-main-cta") && this.modalEl.querySelector(".js-main-cta").removeEventListener("click", r.mainCTACloseAction.bind(r)), this.modalEl.querySelector(".js-secondary-cta") && this.modalEl.querySelector(".js-secondary-cta").removeEventListener("click", r.trackCTAclick.bind(r)), t("rewards_landing"), e && e.show(), _.fe_firusecam_www && (c || u ? (c && s.customGoal(d, 1), u && s.customGoal(d, 2)) : s.customGoal(d, 3)), _.fe_firusecam_mdot && (c || u ? (c && s.customGoal(l, 1), u && s.customGoal(l, 2)) : s.customGoal(l, 3)), _r_()
                    }
                }), this.modal && this.modal.mount(), this.toast = i.createInstance("Toast", null), this.toast && this.toast.mount(), this.setState({
                    has_list: !!n.copy.list.length
                }), o.on("rewards:async_coupon_code_retrieved", function(e) {
                    _i_("44d:a590fd11"), r.setState({
            ...
            afterRender: function() {
                _i_("44d:d9b8f317");
                var e = this.getState();
                this.modal && e.should_landing_modal_open && (_.b_action.match(/index|taxi|dealspage/g) ? (this.modal.open(), this.setState({
                    should_landing_modal_open: !1
                })) : "hotel" === _.b_action && (_.fe_INA_WWW ? (setTimeout(this.delayedModalAutoOpen.bind(this), 5e3), this.setState({
                    should_landing_modal_open: !1
                })) : _.fe_IOU_WWW && (this.delayedModalAutoOpen(), this.setState({
                    should_landing_modal_open: !1
                })))), _r_()
            },
            delayedModalAutoOpen: function() {
                _i_("44d:70e7ee76"), this.getState().reward_token ? this.modal.open() : setTimeout(this.delayedModalAutoOpen.bind(this), 1e3), _r_()
            },
            copyRewardToken: function(e) {
                if (_i_("44d:55cd5096"), !this.timeoutID) {
                    var n = this.getState();
                    clearTimeout(this.timeoutID);
                    var i = document.createElement("textarea");
                    i.style.fontSize = "12pt", i.style.border = "0", i.style.padding = "0", i.style.margin = "0", i.style.position = "absolute", i.style[_.b_lang_rtl ? "right" : "left"] = "-9999px";
                    var r = window.pageYOffset || document.documentElement.scrollTop;
                    i.style.top = r + "px", i.setAttribute("readonly", ""), i.value = n.reward_token, document.body.appendChild(i), i.select(), i.setSelectionRange(0, i.value.length), document.execCommand("copy") && this.toast.show({
                        text: n.copy.copy_cta_done
                    }), document.body.removeChild(i), i = null
                }
                _r_()
            },
            trackCTAclick: function(e) {
                if (_i_("44d:633a1df9"), (_.fe_firusecam_www || _.fe_firusecam_mdot) && e && e.target && e.target.parentElement) {
            ...
            mainCTACloseAction: function(e) {
                _i_("44d:5d70adba"), this.trackCTAclick(e), this.modal && this.modal.close() && this.modal.unmount(), _r_()
            }
        }), _r_()
        ...
        _i_("44d:b9b6dd83"), booking.jstmpl("banner", function() {
            _i_("44d:c8605804");
            ...
            return _r_(function(_) {
                ...
                var e, n, i, r = "",
                    t = this.fn;
                return e = r, _i_("44d:78c3c430"), e += s[0], e += s[1], t.MD(d[0]) && (e += s[2]), t.MD(d[1]) && (e += s[3]), t.MD(d[2]) ? e += s[4] : e += s[5], t.MJ(t.MB(d[3])) && t.MK(t.MB(d[4])) && (e += s[6]), t.MJ(t.MB(d[3])) && t.MJ(t.MB(d[5])) && (e += s[7]), e += s[8], t.MJ(t.MB(d[3])) && t.MK(t.MB(d[4])) ? e += s[9] : (e += s[10], t.MD(d[7]) || (e += s[11], t.MJ(t.MG((t.MC(d[6]) || {}).image)) ? e += [s[12], t.F.entities((t.MC(d[6]) || {}).image), s[13]].join("") : e += [s[14], (_.unshift({
                    color: "#FF8000",
                    name: s[15]
                }), o = t.HELPER("icon", _[0]), _.shift(), o), s[16]].join(""), e += s[17]), e += [s[18], t.F.entities((t.MC(d[8]) || {}).title), s[19], (t.MC(d[8]) || {}).subtitle, s[20]].join(""), t.MJ(t.MB(d[9])) && t.MK(t.MB(d[10])) && (e += [s[21], t.F.entities((t.MC(d[8]) || {}).more_info_open), s[22], t.F.entities((t.MC(d[8]) || {}).more_info_cta), s[23]].join("")), e += s[24], t.MD(d[11]) ? (e += s[25], t.MD(d[7]) || (e += s[26], t.MK(t.MB(d[4])) && (e += s[27]), e += [s[28], t.F.entities((t.MC(d[8]) || {}).copy_cta), s[29]].join("")), e += s[30], t.MJ(t.MB(d[9])) && (e += [s[31], t.F.entities((t.MC(d[8]) || {}).more_info_open), s[32], t.F.entities((t.MC(d[8]) || {}).more_info_cta), s[33]].join("")), e += s[34]) : t.MJ(t.MG((t.MC(d[6]) || {}).cta)) ? (e += s[35], t.MD(d[12]) ? e += [s[36], t.F.entities((t.MC(d[8]) || {}).more_info_open), s[37], t.F.entities((t.MC(d[8]) || {}).copy_link), s[38]].join("") : e += [s[39], t.F.entities((t.MC(d[6]) || {}).cta), s[40], t.F.entities((t.MC(d[8]) || {}).copy_link), s[41]].join(""), e += s[11]) : (e += s[42], t.MD(d[13]) ? e += s[43] : e += [s[44], t.F.entities(t.MC(d[4])), s[45]].join(""), e += s[46], t.MD(d[14]) && (e += s[47], t.MK(t.MB(d[4])) && (e += s[27]), e += [s[48], t.F.entities((t.MC(d[8]) || {}).copy_cta), s[29]].join("")), e += s[49]), e += s[50], t.MD(d[7]) ? (e += s[11], t.MJ(t.MG((t.MC(d[6]) || {}).image)) ? e += [s[51], t.F.entities((t.MC(d[6]) || {}).image), s[13]].join("") : e += [s[52], (_.unshift({
                    color: "#FF8000",
                    name: s[15],
                    width: s[53]
                }), o = t.HELPER("icon", _[0]), _.shift(), o), s[16]].join(""), e += s[17]) : e += [s[54], t.F.entities((t.MC(d[8]) || {}).banner_close), s[55], t.F.entities((t.MC(d[8]) || {}).banner_close), s[56], (_.unshift({
                    class: s[57],
                    name: s[58],
                    width: s[59]
                }), o = t.HELPER("icon", _[0]), _.shift(), o), s[60]].join(""), e += s[10], t.MD(d[9]) && (e += s[11], e = t.MJ(t.MB(d[17]) + "" == "mini_tncs") ? (n = e += s[35], _i_("44d:47268744"), i = n += [s[61], t.F.entities(((t.MC(d[8]) || {}).terms || {}).terms_title), s[62]].join(""), _i_("44d:02bd2759"), i += s[63], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).reward)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).reward), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).minimum_spend)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).minimum_spend), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).expiration_date)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).expiration_date), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).platform)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).platform), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).extra)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).extra), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).maximum_reward)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).maximum_reward), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).payback)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).payback), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).payback_after_checkout)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).payback_after_checkout), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).terms_eight)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).terms_eight), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).terms_nine)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).terms_nine), s[67]].join("")), i += s[10], t.MJ(t.MG(((t.MC(d[8]) || {}).terms || {}).full_tncs_apply)) && (i += s[64], t.MK(t.MB(d[15])) && (i += s[65]), i += [s[66], t.F.entities(((t.MC(d[8]) || {}).terms || {}).full_tncs_apply), s[67]].join("")), i += s[68], n = _r_(i), n += s[69], t.MD(d[16]) ? (n += [s[70], t.F.entities((t.MC(d[6]) || {}).faq), s[71], t.F.entities(((t.MC(d[8]) || {}).terms || {}).item_faq), s[72], t.F.entities((t.MC(d[6]) || {}).terms), s[71], t.F.entities(((t.MC(d[8]) || {}).terms || {}).item_terms), s[73]].join(""), t.MD(d[13]) ? n += s[74] : n += [s[45], t.F.entities(t.MC(d[4])), s[75]].join(""), n += s[76], t.MK(t.MB(d[4])) && (n += s[27]), n += [s[77], t.F.entities((t.MC(d[8]) || {}).copy_cta), s[78]].join("")) : n += [s[79], t.F.entities((t.MC(d[6]) || {}).terms), s[71], t.F.entities(((t.MC(d[8]) || {}).terms || {}).item_terms), s[80], t.F.entities(((t.MC(d[8]) || {}).terms || {}).main_cta), s[81]].join(""), n += s[82], _r_(n)) : function(e) {
                    if (_i_("44d:47832d84"), e += s[83], t.MD(d[15]) ? e += s[84] : e += s[85], e += s[86], t.MD(d[18]) && (e += [s[87], (_.unshift({
                            class: s[57],
                            name: s[88],
                            width: s[59]
                        }), o = t.HELPER("icon", _[0]), _.shift(), o), s[89], t.F.entities((t.MC(d[8]) || {}).employee), s[90]].join("")), e += [s[91], t.F.entities((t.MC(d[8]) || {}).more_info_title), s[92], t.F.entities((t.MC(d[8]) || {}).more_info_subtitle), s[93]].join(""), t.MD(d[19])) {
                        e += s[94];
                        var n = (t.MC(d[8]) || {}).more_info_list || [];
                        _.unshift({
                            item_list: null
                        });
                        for (var i, r = 1, a = n.length; r <= a; r++) _[0].item_list = i = n[r - 1], e += [s[95], t.F.entities(i), s[96]].join("");
                        _.shift(), e += s[97]
                    }
                    return e += s[10], t.MJ(t.MG((t.MC(d[8]) || {}).more_info_fineprint)) || (e += [s[98], t.F.entities((t.MC(d[6]) || {}).terms), s[99], t.F.entities((t.MC(d[8]) || {}).more_info_terms), s[100]].join("")), e += s[101], t.MD(d[20]) ? (e += s[102], t.MD(d[13]) ? e += s[74] : e += [s[45], t.F.entities(t.MC(d[4])), s[75]].join(""), e += s[76], t.MK(t.MB(d[4])) && (e += s[27]), e += [s[77], t.F.entities((t.MC(d[8]) || {}).copy_cta), s[103]].join("")) : e += [s[104], t.F.entities((t.MC(d[8]) || {}).more_info_inner_cta), s[103]].join(""), e += s[105], t.MJ(t.MG((t.MC(d[8]) || {}).more_info_fineprint)) && (e += [s[106], t.F.entities((t.MC(d[8]) || {}).more_info_fineprint), s[107], t.F.entities((t.MC(d[6]) || {}).terms), s[99], t.F.entities((t.MC(d[8]) || {}).more_info_terms), s[108]].join("")), e += s[109], _r_(e)
                }(e += s[35]), e += s[11], e += s[17]), e += s[110]), e += s[111], r = _r_(e), _r_(r)
            })
        }());
        var d = "XdKYEaEVTNeNcJHDUGTOTVMYCBOSVUIRe",
            ...
            u = a.fe_rewards_promo_banner_copy_more_info_steps_list || [].concat(a.fe_rewards_promo_banner_copy_more_info_first_step, a.fe_rewards_promo_banner_copy_more_info_second_step, a.fe_rewards_promo_banner_copy_more_info_third_step).filter(function(e) {
                return _i_("44d:6eb3f6e9"), _r_(0 != e)
            }),
            p = {
        ...
        n.exports = i.extend({
            ...
            initialize: function() {
                ...
                e.is_modal_enabled && (this.modal = n.createInstance("Modal", document.createElement("div"), {
                    ...
                    onBeforeOpen: function() {
                        _i_("44d:61e8f3d7"), this.modalEl.querySelector(".js-copy-modal") && this.modalEl.querySelector(".js-copy-modal").addEventListener("click", i.copyRewardToken.bind(i)), "mini_tncs" === e.modal_type && t(this.modalEl).addClass("rewards-promo-banner__modal--close_reset"), _r_()
                    },
                    onAfterClose: function() {
                        _i_("44d:609c9db4"), this.modalEl.querySelector(".js-copy-modal") && this.modalEl.querySelector(".js-copy-modal").removeEventListener("click", i.copyRewardToken.bind(i)), _r_()
                    }
                }), this.modal && this.modal.mount()), this.toast = n.createInstance("Toast", null), this.toast && this.toast.mount(), e.reward_token || e.is_token_loading ? this.modal && e.should_modal_auto_open && this.openModalOnAutoOpenAndDismiss() : (this.setState({
                    is_token_loading: !0
                }), setTimeout(function(e) {
                    _i_("44d:73b008bd"), e.setState({
                    ...
                    success: function(n) {
                        ...
                        if (n.token) {
                            if (this.setState({
                                ...
                                for (var r in i)
                                    if ("string" == typeof i[r]) - 1 !== i[r].indexOf(_) && (i[r] = i[r].replace(_, "<b>" + n.token + "</b>"));
                                    else if ("object" != typeof i[r] || Array.isArray(i[r])) {
                                    if (Array.isArray(i[r])) {
                                        var a = i[r].map(function(e) {
                                            return _i_("44d:1c3c4bba"), -1 !== e.indexOf(_) && (e = e.replace(_, "<b>" + n.token + "</b>")), _r_(e)
                                        });
                                        i[r] = a
                                    }
                                } else Object.keys(i[r]).forEach(function(e) {
                                    _i_("44d:e315610f"), -1 !== i[r][e].indexOf(_) && (i[r][e] = i[r][e].replace(_, "<b>" + n.token + "</b>")), _r_()
                                });
                                this.setState({
                                    copy: i
                                })
                            }
                            this.modal && e.should_modal_auto_open && this.openModalOnAutoOpenAndDismiss(), e.has_ajax_elapsed_max_time ? !e.is_mdot && o.customGoal(d, 4) : !e.is_mdot && o.customGoal(d, 3), s.trigger("rewards:async_coupon_code_retrieved", {
                                reward_token: n.token
                            })
                        } else this.setState({
                            has_ajax_failed: !0
                    ...
                    error: function() {
                        ...
                        this.setState({
                            has_ajax_failed: !0
                        }), e.has_ajax_elapsed_max_time ? !e.is_mdot && o.customGoal(d, 2) : !e.is_mdot && o.customGoal(d, 1), _r_()
                    },
                    xhrFields: {
                        withCredentials: !0
                    }
            ...
            openModalOnAutoOpenAndDismiss: function() {
                _i_("44d:41525307"), this.modal.open(), this.setState({
                    should_modal_auto_open: !1
                }), _("rewards_promo_banner_modal_auto_open"), _r_()
            },
            openModal: function() {
                _i_("44d:9935ee27"), this.modal.open(), this.setState({
                    should_modal_auto_open: !1
                }), _r_()
            },
            closeBanner: function() {
                _i_("44d:5064fc2e"), this.setState({
                    is_banner_closed: !0
                }), _("rewards_promo_banner"), _r_()
            },
            copyRewardToken: function(e) {
                if (_i_("44d:55cd50961"), !this.timeoutID) {
                    var n = this.getState();
                    clearTimeout(this.timeoutID);
                    var i = document.createElement("textarea");
                    i.style.fontSize = "12pt", i.style.border = "0", i.style.padding = "0", i.style.margin = "0", i.style.position = "absolute", i.style[a.b_lang_rtl ? "right" : "left"] = "-9999px";
                    var r = window.pageYOffset || document.documentElement.scrollTop;
                    i.style.top = r + "px", i.setAttribute("readonly", ""), i.value = n.reward_token, document.body.appendChild(i), i.select(), i.setSelectionRange(0, i.value.length), document.execCommand("copy") && this.toast.show({
                        text: n.copy.copy_cta_done
                    }), document.body.removeChild(i), i = null
        ...
        _i_("44d:c80ae3cc");
        var n = e("et");
        "www" === B.env.b_site_type && "hotel" === B.env.b_action && n.stage("XdKYEaEVTNeNcJHDUGTOTVMYCBOSVUIRe", 2), _r_()
    }), B.define("component/rewards-ui/promo-code-storage", function(e, n, i) {
        var r;
        _i_("44d:33ee5288");
        try {
            (r = window.localStorage).setItem("_t", "_"), r.removeItem("_t")
        } catch (e) {
            r = null
        }
        ...
        i.exports = {
            setCoupon: function(e) {
                _i_("44d:06d72f22"), r && r.setItem(a, e), _r_()
            },
            getCoupon: function() {
                return _i_("44d:15e5148b"), _r_(r ? r.getItem(a) : null)
            },
            removeCoupon: function() {
                _i_("44d:ad56fcbe"), r && r.removeItem(a), _r_()
            }
        }, _r_()
        ...
        n.exports = {
            ...
            getStoredRewardCode: function() {
                return _i_("44d:381b7460"), _r_(function(i) {
                    ...
                    if (i(this.handleRetrieveStoredReward(e)), e) i(this.requestActiveReward(e, !0));
                        ...
                        n = r ? r.get_user_total_discount() : 0, t.ajax({
                            ...
                            success: function(e) {
                                if (_i_("44d:3789d197"), !e.auto_applicable_coupon_found) return _r_();
                                var n = e.coupon_code;
                                i(this.handleRewardSuccess(e, n)), _r_()
                            },
                            error: function() {},
                            xhrFields: {
                                withCredentials: !0
            ...
            requestActiveReward: function(r, a, _) {
                return _i_("44d:88719471"), _r_(function(i) {
                    if (_i_("44d:ff293463"), i(this.fetchingActiveReward()), !_) {
                        var e = d.getInstance();
                    ...
                    if (0 == r.length) return i(this.handleRewardError(this._errorMessage("E_NO_INCENTIVE_LINK"))), _r_();
                    if (r === s.getCoupon() && !a) return 1 < o.fe_new_coupon_layout ? i(this.handleRewardAlreadyUsed()) : i(this.handleRewardError(this._errorMessage("E_ALREADY_REDEEMED"))), _r_();
                    if (o.b_hotel_doesnt_need_cc_data && !o.fe_email_for_coupons && !n) return i(this.handleRewardError(this._errorMessage("E_EMAIL_MISSING"))), _r_();
                    t.ajax({
                        ...
                        context: this,
                        success: function(e) {
                            if (_i_("44d:861df602"), e.valid) i(this.handleRewardSuccess(e, r));
                            else if (a) i(this.resetCouponForm());
                            else {
                        ...
                        error: function(e) {
                            _i_("44d:498734e4"), i(this.handleRewardError(this._errorMessage("E_UNKNOWN_ERROR"))), _r_()
                        },
                        xhrFields: {
                            withCredentials: !0
                        }
            ...
            requestRemoveReward: function() {
                return _i_("44d:b40aef9d"), _r_(function(n) {
                    _i_("44d:00a5d7e2"), n(this.fetchingRewardRemoval()), t.ajax({
                        ...
                        context: this,
                        success: function(e) {
                            _i_("44d:34f4b018"), n(this.handleRemoveRewardSuccess()), _r_()
                        },
                        error: function(e) {
                            _i_("44d:5c36c1c6"), n(this.handleRemoveRewardFail()), _r_()
                        },
                        xhrFields: {
                            withCredentials: !0
                        }
        ...
        _i_("44d:d4f3c49d"), n.exports = i.extend({
            store: a,
            initialState: a.getState(),
            template: "promo_card_block",
            initialize: function() {
                _i_("44d:e9de9371"), this.BUI = window.BUI || null, this.modal = this.BUI && this.BUI.createInstance("Modal", document.createElement("div"), {
                    id: "rewards-modal-error"
                }), this.modalIsMounted = !1, this.store.subscribe(this._initComponent.bind(this)), this.store.dispatch(_.getStoredRewardCode()), this.setState({
                    mdot_static_container: s.b_user_has_valid_incentive
                }), c.on("campaign::discounts::changed", this.handleDiscountChange.bind(this)), _r_()
            },
            handleInputChange: function(e) {
                _i_("44d:b77e65f6"), this.store.dispatch(_.setCouponCode(e.target.value)), _r_()
            },
            handleInputKeydown: function(e) {
                _i_("44d:39745870"), 13 === e.keyCode && (e.preventDefault(), this.store.dispatch(_.requestActiveReward(this.store.getState().ui.coupon_code))), _r_()
            },
            handleSubmitButton: function() {
                _i_("44d:aa03631b"), this.store.dispatch(_.requestActiveReward(this.store.getState().ui.coupon_code)), _r_()
            },
            handleRemoveCard: function(e) {
                _i_("44d:78fb07ea"), e.preventDefault(), this.store.dispatch(_.requestRemoveReward()), _r_()
            },
            toggleFormVisibility: function(e) {
                _i_("44d:636a4812"), e.preventDefault(), this.store.dispatch(_.toggleFormVisibility(this.store.getState().ui.isFormHidden)), _r_()
            },
            toggleAccordionVisibility: function(e) {
                _i_("44d:f85728e9"), e.preventDefault(), this.store.dispatch(_.toggleAccordionVisibility()), _r_()
            },
            handleDiscountChange: function(e) {
                _i_("44d:0e76f513"), (this.store.getState().reward.reward_code || this.store.getState().ui.coupon_code) && this.store.dispatch(_.requestActiveReward(this.store.getState().reward.reward_code, !0, e.user_total_discount)), _r_()
            },
            _initComponent: function() {
                _i_("44d:cb674b4e");
                var e = this.store.getState();
                t.hasValidReward(e) && this.BUI && this.BUI.initComponents && window.BUI.initComponents(this.el.querySelector(".js-promo-code-card")), t.shouldOpenNonEligibleModal(e) && !this.modalIsMounted ? (this.modalIsMounted = !0, this.modal.mount(), this.modal.updateContent(o("error_modal").render({
                    store: e
                })), this.modal.open()) : !t.shouldOpenNonEligibleModal(e) && this.modalIsMounted && (this.modalIsMounted = !1, this.modal.unmount()), _r_()
            }
        }), _r_()
        ...
        n.exports = i.createStore(i.combineReducers({
            reward: function(e, n) {
                switch (_i_("44d:34151bc4"), e = e || d.reward, n.type) {
            ...
            ui: function(e, n) {
                switch (_i_("44d:b2825a30"), e = e || d.ui, n.type) {
            ...
            error: function(e, n) {
                switch (_i_("44d:f65df34c"), e = e || d.error, n.type) {
                    case r.REMOVE_STORED_REWARD:
                    case r.SET_COUPON_CODE:
                        return _r_(d.error);
                    case r.RESPONSE_REWARD_REMOVAL_FAIL:
        ...
        }), d, c(i.applyMiddleware(_.default || _, a.etTrackingMiddleware, a.storageMiddleware, a.sideEffectsMiddleware))), _r_()
    }), B.define("component/rewards-ui-redux/promo-code-templates", function() {
        _i_("44d:37646a75"), booking.jstmpl("promo_card_block", function() {
            _i_("44d:c2bddbad");
            var s, d = ['<div class="bui-card bp-card--promo-code active_offer_block ', " ", " aob-offer-is-active", '">\n    <div class="bui-card__content">\n        <header class="bui-card__header">\n            <h2 class="bui-card__title">\n                ', "\n                    ", "\n                ", '\n            </h2>\n        </header>\n        <div class="bui-card__text">\n            ', '<div class="bui-banner bui-u-bleed@small bui-u-padding-bottom--4 js-aob--coupon" data-bui-component="Banner">\n    <input\n        type="hidden"\n        form="bookForm"\n        name="coupon_code"\n        value="', '"\n    />\n    <input\n        type="hidden"\n        form="bookForm"\n        name="promotion_code"\n        value="', '"\n    />\n    <input\n        type="hidden"\n        form="bookForm"\n        name="promotion_type"\n        value="', '"\n    />\n\n    ', '\n        <span class="bui-banner__icon">\n            ', "streamline/coupon_discount", "\n            ", "\n        </span>\n    ", '\n        <div class="bui-banner__image-container aob__image-container">\n            <img width="64" height="64" class="bui-banner__image" alt="" src="', '" />\n        </div>\n    ', '\n\n    <div class="bui-banner__content bui-u-margin-bottom--16">\n        ', '\n            <div class="bui-banner__title bui_font_strong">\n                ', "\n            </div>\n        ", "\n        ", '\n            <p class="bui-banner__text', " bui-u-margin-top--8", '">\n                ', "\n            </p>\n        ", '\n        <ul class="bui-list bui-list--text bui-list--icon bui-u-margin-top--8 bui-u-margin-bottom--8">\n            ', '\n                <li class="bui-list__item bui-u-margin-bottom--8">\n                    <span class="bui-list__icon" role="presentation">\n                        ', "small", '\n                    </span>\n                    <div class="bui-list__body">\n                        <div class="bui-list__description">\n                            ', '\n                        </div>\n                    </div>\n                </li>\n                <li class="bui-list__item bui-u-margin-bottom--8">\n                    <span class="bui-list__icon" role="presentation">\n                        ', "streamline/calendar", "\n                                ", "\n                            ", "\n                        </div>\n                    </div>\n                </li>\n            ", '\n                        </div>\n                    </div>\n                </li>\n                <li class="bui-list__item">\n                    <span class="bui-list__icon" role="presentation">\n                        ', "streamline/gift", '\n        </ul>\n        <div class="bui-group bui-group--inline aob-button-group-margin-adjust">\n            <div class="bui-group__item">\n                <button\n                    data-bui-component="Popover"\n                    data-popover-content-id="active_offer-terms"\n                    data-popover-position="top"\n                    tabindex="0"\n                    class="bui-button bui-button--tertiary js-aob--more-info-button"\n                    type="button"\n                >\n                    <span class="bui-button__text">', '</span>\n                </button>\n            </div>\n            <div class="bui-group__item">\n                <button on:click="handleRemoveCard" class="bui-button bui-button--tertiary js-aob--remove-button" type="button" ', "disabled", '>\n                    <span class="bui-button__text">', '</span>\n                </button>\n            </div>\n        </div>\n    </div>\n    <div id="active_offer-terms" class="bui-card bui-u-hidden">\n        <div class="bui-card__content">\n            <header class="bui-card__header">\n                <h3 class="bui-card__title">', '</h3>\n            </header>\n            <ol class="bui-list bui-list--ordered bui-u-margin-top--8">\n                ', '\n                    <li class="bui-list__item">', "</li>\n                ", '\n            </ol>\n            <ul class="bui-list bui-list--text bui-u-margin-top--16">\n                <li class="bui-list__item">\n                    <a href="', '" class="bui-link bui-link--primary" target="_blank">\n                        ', '\n                    </a>\n                </li>\n                <li class="bui-list__item">\n                    <a href="', "\n                    </a>\n                </li>\n            </ul>\n        </div>\n    </div>\n</div>\n", '\n    <div class="bui-container bui-u-padding-top--8 bui-u-padding-bottom--8">\n        ', '\n            <div class="bui-alert bui-u-bleed@small bui-alert--inline bui-alert--error bui-u-margin-bottom--8" role="status">\n                <span class="bui-alert__icon">\n                    ', "streamline/warning", '\n                </span>\n                <div class="bui-alert__description">\n                    <p class="bui-alert__text">', "</p>\n                </div>\n            </div>\n        ", "\n    </div>\n", "\n", '\n                <hr class="bui-divider" />\n                <ul class="bui-accordion bui-u-bleed@small">\n                    <li class="bui-accordion__row', " bui-is-active", '">\n                        <button on:click="toggleFormVisibility" class="bui-accordion__row-inner js-aob--acordion-button" data-bui-ref="accordion-button" aria-controls="content-active_offer_block_form" aria-expanded="', '" type="button">\n                            <div class="bui-accordion__row-header">\n                                <p class="bui-accordion__subtitle">\n                                    ', '\n                                </p>\n                            </div>\n                            <span role="presentation" class="bui-accordion__icon-container">\n                                ', "bui-accordion__icon", "streamline/arrow_nav_down", "24", '\n                            </span>\n                        </button>\n                        <div id="content-active_offer_block_for" class="bui-accordion__content" role="region">\n                            ', '\n    <div class="bui-alert bui-u-bleed@small bui-alert--inline bui-alert--info bui-u-padding-bottom--16" role="status">\n        <span class="bui-alert__icon">\n            ', "", "streamline/info_sign", '\n        </span>\n        <div class="bui-alert__description">\n            <p class="bui-alert__text">', "</p>\n        </div>\n    </div>\n", '\n<div class="bui-form__group', " bui-has-error", '">\n    <label class="bui-form__label" for="coupon_code_input">\n        ', '\n    </label>\n    <div class="bui-input-text__content">\n        <div class="bui-input-text__field">\n            <input\n                type="text"\n                on:input="handleInputChange"\n                on:keydown="handleInputKeydown"\n                id="coupon_code_input"\n                class="bui-input-text__control js-aob--form-input"\n                autocomplete="false"\n                name="coupon_code_input"\n                form="bookForm"\n                value="', '"\n                ', 'aria-describedby="coupon_code-error"', '\n            />\n            <div class="bui-input-text__decorator"></div>\n            ', '\n                <div class="bui-input-text__side">\n                    <span class="bui-icon bui-icon--medium bui-icon--color-destructive" role="presentation">\n                        <svg viewBox="0 0 24 24" width="1em" height="1em" iconset="streamline" name="Warning" focusable="false" aria-hidden="true" role="img">\n                            <path d="M12 15.75A1.125 1.125 0 1 0 12 18a1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zm.75-2.25V5.25a.75.75 0 0 0-1.5 0v8.25a.75.75 0 0 0 1.5 0zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z"></path>\n                        </svg>\n                    </span>\n                </div>\n            ', '\n                <div class="bui-input-text__side">\n                    <span class="bui-icon bui-icon--medium bui-icon--color-constructive" role="presentation">\n                        <svg viewBox="0 0 128 128" width="1em" height="1em" iconset="streamline" name="CheckmarSelected" focusable="false" aria-hidden="true" role="img">\n                            <path d="M56.62 93.54a4 4 0 0 1-2.83-1.18L28.4 67a4 4 0 1 1 5.65-5.65l22.13 22.1 33-44a4 4 0 1 1 6.4 4.8L59.82 91.94a4.06 4.06 0 0 1-2.92 1.59zM128 64c0-35.346-28.654-64-64-64C28.654 0 0 28.654 0 64c0 35.346 28.654 64 64 64 35.33-.039 63.961-28.67 64-64zm-8 0c0 30.928-25.072 56-56 56S8 94.928 8 64 33.072 8 64 8c30.914.033 55.967 25.086 56 56z"></path>\n                        </svg>\n                    </span>\n                </div>\n            ', "\n        </div>\n    </div>\n    ", '\n            <div class="bui-form__error" id="coupon_code-error" role="alert">', "</div>\n        ", "\n    ", '\n         <div class="aob-form__feedback" role="alert">', "</div>\n    ", '\n</div>\n<button class="bui-button bui-button--secondary bui-u-margin-top--8  js-aob--form-submit', " bui-is-loading", '" type="button" on:click="handleSubmitButton" ', ' >\n    <div class="bui-button__loader" aria-busy="true" aria-live="polite">\n        <div class="bui-spinner bui-spinner--size-small">\n            <div class="bui-spinner__inner"></div>\n        </div>\n    </div>\n    <span class="bui-button__text">\n        ', "\n    </span>\n</button>\n", "\n                        </div>\n                    </li>\n                </ul>\n            ", "\n        </div>\n    </div>\n</div>"],
                l = ["fe_classnames_responsive_container", "store"];
            return _r_(function(t) {
                ...
                function i(e) {
                    if (_i_("44d:7a0d59b2"), o.MJ(o.MC(l[1]).reward.hasValidReward) && o.MJ(o.MC(l[1]).ui.copy.form_warning_message) && (e += [d[64], (t.unshift({
                            class: d[65],
                            name: d[66],
                            width: d[62]
                        }), s = o.HELPER("icon", t[0]), t.shift(), s), d[67], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).form_warning_message), d[68]].join("")), e += d[69], o.MJ(o.MG(((o.MC(l[1]) || {}).error || {}).hasErrors)) && (e += d[70]), e += [d[71], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).form_label), d[72], o.F.entities(((o.MC(l[1]) || {}).ui || {}).coupon_code), d[73]].join(""), o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isLoading)) && (e += d[38]), e += d[5], o.MJ(o.MG(((o.MC(l[1]) || {}).error || {}).hasErrors)) && (e += d[74]), e += d[75], o.MJ(o.MG(((o.MC(l[1]) || {}).error || {}).hasErrors)) ? e += d[76] : o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).showFeedbackMsg)) && (e += d[77]), e += d[78], o.MJ(o.MG(((o.MC(l[1]) || {}).error || {}).hasErrors))) {
                        e += d[20];
                        var n = ((o.MC(l[1]) || {}).error || {}).errorMsg || [];
                        t.unshift({
                            error: null
                        });
                        for (var i, r = 1, a = n.length; r <= a; r++) t[0].error = i = n[r - 1], e += [d[79], o.F.html(i), d[80]].join("");
                        t.shift(), e += d[81]
                    } else o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).showFeedbackMsg)) && (e += [d[82], o.F.html((((o.MC(l[1]) || {}).ui || {}).copy || {}).form_coupon_already_used_no_error), d[83]].join(""));
                    return e += d[84], o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isLoading)) && (e += d[85]), e += d[86], o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isLoading)) && (e += d[38]), e += [d[87], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).form_apply_coupon), d[88]].join(""), _r_(e)
                }
                return e = n, _i_("44d:b847db48"), e += [d[0], o.F.entities(o.MC(l[0])), d[1]].join(""), o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).hasValidReward)) && (e += d[2]), e += d[3], o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).hasValidReward)) ? e += [d[4], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).block_title_with_reward), d[5]].join("") : e += [d[4], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).block_title_no_reward), d[5]].join(""), e += d[6], o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).hasValidReward)) ? (e = function(e) {
                    _i_("44d:33fa5432"), e += [d[7], o.F.entities(((o.MC(l[1]) || {}).reward || {}).reward_code), d[8], o.F.entities((((o.MC(l[1]) || {}).reward || {}).promotion || {}).value), d[9], o.F.entities((((o.MC(l[1]) || {}).reward || {}).promotion || {}).type), d[10]].join(""), o.MJ(o.MC(l[1]).reward.icon + "" == "coupon_discount") ? (e += d[11], o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).isEligible)) ? e += [d[5], (t.unshift({
                        color: "#FF8000",
                        name: d[12]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[13]].join("") : e += [d[5], (t.unshift({
                        color: "#BDBDBD",
                        name: d[12]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[13]].join(""), e += d[14]) : o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).image)) ? e += [d[15], ((o.MC(l[1]) || {}).reward || {}).image, d[16]].join("") : (e += d[11], o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).isEligible)) ? e += [d[5], (t.unshift({
                        color: "#FF8000",
                        name: d[12]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[13]].join("") : e += [d[5], (t.unshift({
                        color: "#BDBDBD",
                        name: d[12]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[13]].join(""), e += d[14]), e += d[17], o.MJ(o.MG((((o.MC(l[1]) || {}).reward || {}).copy || {}).title)) && (e += [d[18], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).title), d[19]].join("")), e += d[20], o.MJ(o.MG((((o.MC(l[1]) || {}).reward || {}).copy || {}).message)) && (e += d[21], o.MJ(o.MG((((o.MC(l[1]) || {}).reward || {}).copy || {}).title)) && (e += d[22]), e += [d[23], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).message), d[24]].join("")), e += d[25], o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isCouponNewLayout)) ? (e += [d[26], (t.unshift({
                        color: "#6B6B6B",
                        name: d[12],
                        size: d[27]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[28], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_coupon_value), d[29], (t.unshift({
                        color: "#6B6B6B",
                        name: d[30],
                        size: d[27]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[28]].join(""), o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).formatted_expiry_date)) ? e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_coupon_with_expiration_date), d[32]].join("") : e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_coupon_no_expiration_date), d[32]].join("")) : (e += [d[26], (t.unshift({
                        color: "#6B6B6B",
                        name: d[30],
                        size: d[27]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[28]].join(""), o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).formatted_expiry_date)) ? e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_coupon_with_expiration_date), d[32]].join("") : e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_coupon_no_expiration_date), d[32]].join(""), e += [d[34], (t.unshift({
                        color: "#6B6B6B",
                        name: d[35],
                        size: d[27]
                    }), s = o.HELPER("icon", t[0]), t.shift(), s), d[28]].join(""), o.MJ(o.MC(l[1]).reward.reward_type + "" == "REWARD_TYPE_CASHBACK") && (e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_reward_type_cashback), d[32]].join("")), e += d[32], o.MJ(o.MC(l[1]).reward.reward_type + "" == "REWARD_TYPE_VIRTUAL_CREDIT") && (e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_reward_type_virtual_credit), d[32]].join("")), e += d[32], o.MJ(o.MC(l[1]).reward.reward_type + "" == "REWARD_TYPE_CASHOUT") && (e += [d[31], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions_reward_type_cashout), d[32]].join(""))), e += d[33], e += [d[36], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).cta_more_info), d[37]].join(""), o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isLoading)) && (e += d[38]), e += [d[39], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).cta_remove_coupon), d[40], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).terms_title), d[41]].join("");
                    var n = (((o.MC(l[1]) || {}).reward || {}).copy || {}).conditions || [];
                    t.unshift({
                        condition: null
                    });
                    for (var i, r = 1, a = n.length; r <= a; r++) t[0].condition = i = n[r - 1], e += [d[42], o.F.entities(i), d[43]].join("");
                    if (t.shift(), e += [d[44], o.F.entities((((o.MC(l[1]) || {}).reward || {}).url || {}).terms), d[45], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).terms_cta_terms), d[46], o.F.entities((((o.MC(l[1]) || {}).reward || {}).url || {}).faq), d[45], o.F.entities((((o.MC(l[1]) || {}).reward || {}).copy || {}).terms_cta_faq), d[47]].join(""), !o.MJ(o.MG(((o.MC(l[1]) || {}).reward || {}).isEligible))) {
                        e += d[48];
                        var n = (((o.MC(l[1]) || {}).reward || {}).copy || {}).non_eligible || [];
                        t.unshift({
                            error: null
                        });
                        for (var _, r = 1, a = n.length; r <= a; r++) t[0].error = _ = n[r - 1], e += [d[49], (t.unshift({
                            name: d[50]
                        }), s = o.HELPER("icon", t[0]), t.shift(), s), d[51], o.F.entities(_), d[52]].join("");
                        t.shift(), e += d[53]
                    }
                    return e += d[54], _r_(e)
                }(e += d[5]), e += d[55], o.MJ(o.MG(((o.MC(l[1]) || {}).ui || {}).isFormHidden)) || (e += d[56]), e = i(e += [d[57], o.F.entities(o.MK(o.MC(l[1]).ui.isFormHidden)), d[58], o.F.entities((((o.MC(l[1]) || {}).ui || {}).copy || {}).form_code_replace), d[59], (t.unshift({
                    class: d[60],
                    name: d[61],
                    width: d[62]
                }), s = o.HELPER("icon", t[0]), t.shift(), s), d[63]].join("")), e += d[89]) : (e = i(e += d[5]), e += d[13]), e += d[90], n = _r_(e), _r_(n)
            })
            ...
            return _r_(function(e) {
                ...
                var n, i = "",
                    r = this.fn;
                return n = i, _i_("44d:812d9dc3"), r.MJ(r.MB(_[0]) + "" == "E_NO_INCENTIVE_LINK") ? n += [r.ME(a[0], r.MB, r.MN, null), a[1]].join("") : r.MJ(r.MB(_[0]) + "" == "E_ALREADY_REDEEMED") ? n += [r.ME(a[2], r.MB, r.MN, null), a[1]].join("") : r.MJ(r.MB(_[0]) + "" == "E_UNKNOWN_ERROR") ? n += [r.ME(a[3], r.MB, r.MN, null), a[1]].join("") : r.MJ(r.MB(_[0]) + "" == "E_EMAIL_MISSING") && (n += [r.ME(a[4], r.MB, r.MN, null), a[1]].join("")), i = _r_(n), _r_(i)
            })
            ...
            return _r_(function(_) {
                ...
                var e = "",
                    t = this.fn;
                return e = function(e) {
                    _i_("44d:42546980"), e += [s[0], t.STATIC_HOSTNAME("/static/img/incentives/incentippy_gray.svg", 0, 0, 0, 0), s[1], t.ME(s[2], t.MB, t.MN, null), s[3], t.ME(s[4], t.MB, t.MN, null), s[5]].join("");
                    var n = (((t.MC(d[0]) || {}).reward || {}).copy || {}).non_eligible || [];
                    _.unshift({
                        error_message: null
                    });
                    for (var i, r = 1, a = n.length; r <= a; r++) _[0].error_message = i = n[r - 1], e += [s[6], (_.unshift({
                        name: s[7],
                        role: s[8],
                        width: s[9]
                    }), o = t.HELPER("icon", _[0]), _.shift(), o), s[10], t.F.html(i), s[11]].join("");
                    return _.shift(), e += [s[12], t.F.entities((((t.MC(d[0]) || {}).reward || {}).url || {}).terms), s[13], t.ME(s[14], t.MB, t.MN, null), s[15], t.ME(s[16], t.MB, t.MN, null), s[17]].join(""), _r_(e)
                }(e), _r_(e)
            })
        }()), _r_()
    }), B.define("component/rewards-ui-redux/promo-code-selectors", ["exports", "module"], function(e, n) {
        _i_("44d:c546b0eb"), n.exports = {
            shouldOpenNonEligibleModal: function(e) {
                return _i_("44d:180670e9"), _r_(!e.reward.isEligible && "force_majeure_campaign" === e.reward.campaign_tag)
            },
            hasValidReward: function(e) {
                return _i_("44d:8165b2dd"), _r_(e.reward && e.reward.hasValidReward)
            }
        }, _r_()
        ...
        _i_("44d:dcecadcb"), n.exports = {
            etTrackingMiddleware: function(e) {
                return _i_("44d:c5db49f7"), _r_(function(n) {
                    return _i_("44d:b991c2cf"), _r_(function(e) {
                        return _i_("44d:93416a5b"), e.type, _r_(n(e))
                    })
                })
            },
            storageMiddleware: function(e) {
                return _i_("44d:e9736847"), _r_(function(n) {
                    return _i_("44d:c6f16c2d"), _r_(function(e) {
                        switch (_i_("44d:15ae06d0"), e.type) {
                            case i.REMOVE_STORED_REWARD:
                                return a.removeCoupon(), _r_(n(e));
                            case i.RESPONSE_REWARD_ACTIVATION_SUCCESS:
                                return a.setCoupon(e.payload.reward_code), _r_(n(e));
            ...
            sideEffectsMiddleware: function(e) {
                return _i_("44d:45e62b29"), _r_(function(n) {
                    return _i_("44d:e9a8d068"), _r_(function(e) {
                        switch (_i_("44d:efe6affd"), e.type) {
                            case i.RESPONSE_REWARD_ACTIVATION_SUCCESS:
                                return t.isImprovedDesktopUI && "msie" === t.b_browser && "11" === t.b_browser_version && function(e) {
                                    if (_i_("44d:f7928ec0"), _('#bookForm > input[name="coupon_code"]').remove(), _('#bookForm > input[name="promotion_code"]').remove(), _('#bookForm > input[name="promotion_type"]').remove(), e.reward_code && e.reward && e.reward.promotion && e.reward.promotion.value && e.reward.promotion.type) {
                                        var n = document.createElement("input");
                                        n.type = "hidden", n.form = "bookForm", n.name = "coupon_code", n.value = e.reward_code;
                                        var i = document.createElement("input");
                                        i.type = "hidden", i.form = "bookForm", i.name = "promotion_code", i.value = e.reward.promotion.value;
                                        var r = document.createElement("input");
                                        r.type = "hidden", r.form = "bookForm", r.name = "promotion_type", r.value = e.reward.promotion.type, _("#bookForm").append(n, i, r)
                                    }
                                    _r_()
                                }(e.payload), _r_(n(e));
                            case i.RESPONSE_REWARD_REMOVAL_FAIL:
                            case i.RESPONSE_REWARD_REMOVAL_SUCCESS:
                                return t.isImprovedDesktopUI && "msie" === t.b_browser && "11" === t.b_browser_version && (e.payload, _i_("44d:38a66833"), _('#bookForm > input[name="coupon_code"]').remove(), _('#bookForm > input[name="promotion_code"]').remove(), _('#bookForm > input[name="promotion_type"]').remove(), _r_()), _r_(n(e));
                            default:
                                return _r_(n(e))
                        }
                        _r_()
        ...
        _i_("44d:d5700a59"), booking.jstmpl("feedback_modal", function() {
            _i_("44d:22dea1dc");
            ...
            return _r_(function(e) {
                ...
                var n, i = "",
                    r = this.fn;
                return n = i, _i_("44d:ff7e73be"), n += [_[0], (e.unshift({
                    color: "#BDBDBD",
                    name: _[1]
                }), a = r.HELPER("icon", e[0]), e.shift(), a), _[2], r.F.entities((r.MC(t[0]) || {}).title), _[3], r.F.entities((r.MC(t[0]) || {}).subtitle), _[4], r.F.entities((r.MC(t[0]) || {}).cta), _[5]].join(""), i = _r_(n), _r_(i)
            })
        }());
        var t = {
        ...
        i.exports = r.extend({
            ...
            initialize: function() {
                ...
                }), this.modal && this.modal.mount(), this.modal && this.modal.open(), _r_()
            }
        }), _r_()
