function UET(o) {
    ...
    this.loadConfig = function() {
        ...
        this.stringExists(o.ti) && (n = document.createElement("script"), y = e + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (y += "?bat_debug=" + this.uetConfig.batDebug), n.src = y, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
